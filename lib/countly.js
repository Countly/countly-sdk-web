...
(function(root, factory) {
    ...
    */
    ...
    Countly.init = function(conf) {
        conf = conf || {};
        if (Countly.apm && shouldLetApmLoading) {
            shouldLetApmLoading = false;
            initAfterAPM(conf);
            return;
        }
    ...
    function initAfterAPM(conf) {
        ...
        boomerangScript.src = Countly.boomSrc || CDN.BOOMERANG_SRC;
        countlyBoomerangScript.src = Countly.clyBoomSrc || CDN.CLY_BOOMERANG_SRC;
