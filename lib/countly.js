...
(function (global, factory) {
  ...
  var CountlyClass = /*#__PURE__*/ _createClass(function CountlyClass(ob) {
    ...
    this.initialize = function () {
      ...
      this.clearStoredId = !isBrowser
        ? undefined
        : getConfig("clear_stored_id", ob, false);
      ...
      this.ignore_bots = !isBrowser
        ? undefined
        : getConfig("ignore_bots", ob, true);
  ...
  function currentUserAgentString(uaOverride) {
    ...
    if (!ua_raw) {
      if (navigator.userAgentData) {
        ...
        ua_raw = navigator.userAgentData.brands
          .map(function (e) {
...
//# sourceMappingURL=countly_umd.js.map
