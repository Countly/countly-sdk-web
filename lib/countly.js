...
(function(root, factory) {
    ...
    */
    ...
    var CountlyClass = function(ob) {
        ...
        * */
         ...
         *  @param {String} eventId - countly event ID
         */
        function add_cly_events(event, eventId) {
            // ignore bots
            ...
            if (!Object.values(internalEventKeyEnums).includes(event.key)) {
    ...
    * */
    ...
    function generateUUID() {
        ...
        uuid = replaceRandomValues(uuid, "[xy]");
    ...
    */
    function replaceRandomValues(str, pattern) {
