    ...
    var CountlyClass = function(ob) {
        ...
        **/
        this.track_forms = function(parent, trackHidden) {
            ...
            if (parent) {
                log(logLevelEnums.INFO, "track_forms, Tracking the specified children");
            }
            parent = parent || document;
            if (trackHidden) {
                log(logLevelEnums.INFO, "track_forms, Tracking hidden inputs");
            }
            /**
        ...
        **/
        this.collect_from_forms = function(parent, useCustom) {
            ...
            if (parent) {
                log(logLevelEnums.INFO, "collect_from_forms, Tracking the specified children");
            }
            parent = parent || document;
            if (useCustom) {
        ...
        */
        this.initializeRatingWidgets = function(enableWidgets) {
            ...
            if (enableWidgets) {
                log(logLevelEnums.INFO, "initializeRatingWidgets, Provided widget IDs: [ " + enableWidgets + " ]");
            }
            if (!this.check_consent(featureEnums.STAR_RATING)) {
                return;
            }
        ...
        **/
        this.get_available_feedback_widgets = function(callback) {
            ...
            if (callback) {
                log(logLevelEnums.INFO, "get_available_feedback_widgets, Callback function is provided");
            }
        ...
        **/
        ...
        function log(level, message, ...args) {
            if (self.debug && typeof console !== "undefined") {
                ...
                else if (level !== logLevelEnums.INFO && level !== logLevelEnums.VERBOSE) {
