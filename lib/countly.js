    ...
    function processWidget(currentWidget, hasSticker){
        try {
            ...
            if(hasSticker) {
                ...
                sticker.innerHTML = sticker.innerHTML = '<img src="'+Countly.url+'/star-rating/images/star-rating/grin-regular.svg" class="feedback-sticker-svg"/>' + currentWidget.trigger_button_text;
