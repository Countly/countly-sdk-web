    ...
    var CountlyClass = function(ob) {
        ...
        */
        this.begin_session = function(noHeartBeat, force) {
            log(logLevelEnums.INFO, "begin_session, Starting the session, without heartbeat: [ " + noHeartBeat + " ] and irrespective of session cookie: [ " + force + " ]");
        ...
        **/
        this.change_id = function(newId, merge) {
            log(logLevelEnums.INFO, "change_id, Changing the ID, with merge is set to: [ " + merge + " ]");
        ...
        **/
        this.recordDirectAttribution = function(campaign_id, campaign_user_id) {
            log(logLevelEnums.INFO, "recordDirectAttribution, Recording the attribution");
            if (this.check_consent(featureEnums.ATTRIBUTION)) {
                ...
                log(logLevelEnums.INFO, "recordDirectAttribution, Provided values for campaign ID is: [ " + campaign_id + " ] and for the user ID is: [ " + campaign_user_id + " ]");
        ...
        this.userData = {
            ...
            **/
            set: function(key, value) {
                log(logLevelEnums.INFO, "set, Setting user's custom property value: [ " + value + " ] with key: [ " + key + " ] ");
            ...
            **/
            set_once: function(key, value) {
                log(logLevelEnums.INFO, "set_once, Setting user's unique custom property value: [ " + value + " ] with key: [ " + key + " ] ");
                //truncate user's custom property value to internal limits
            ...
            **/
            increment: function(key) {
                log(logLevelEnums.INFO, "increment, Increasing user's custom property with key: [ " + key + " ] by one ");
            ...
            **/
            increment_by: function(key, value) {
                log(logLevelEnums.INFO, "increment_by, Increasing user's custom property value: [ " + value + " ] with key: [ " + key + " ] ");
            ...
            **/
            multiply: function(key, value) {
                log(logLevelEnums.INFO, "multiply, Multiplying user's custom property value: [ " + value + " ] with key: [ " + key + " ] ");
            ...
            **/
            max: function(key, value) {
                log(logLevelEnums.INFO, "max, Saving user's max custom property value: [ " + value + " ] with key: [ " + key + " ] ");
                //truncate key value pair wrt internal limits
            ...
            **/
            min: function(key, value) {
                log(logLevelEnums.INFO, "min, Saving user's min custom property value: [ " + value + " ] with key: [ " + key + " ] ");
                //truncate key value pair wrt internal limits
            ...
            **/
            push: function(key, value) {
                log(logLevelEnums.INFO, "push, Pushing a value: [ " + value + " ] with key: [ " + key + " ]  to user's custom property array");
                //truncate key value pair wrt internal limits
            ...
            **/
            push_unique: function(key, value) {
                log(logLevelEnums.INFO, "push_unique, Pushing a unique value: [ " + value + " ] with key: [ " + key + " ] to user's custom property array");
                //truncate key value pair wrt internal limits
            ...
            **/
            pull: function(key, value) {
                log(logLevelEnums.INFO, "pull, Removing the value: [ " + value + " ] with key: [ " + key + " ] from user's custom property array");
        ...
        **/
        this.add_log = function(record) {
            log(logLevelEnums.INFO, "add_log, Adding a new log of breadcrumb: [ " + record + " ]");
        ...
        **/
        this.track_clicks = function(parent) {
            ...
            log(logLevelEnums.INFO, "track_clicks, Starting to track clicks of the children [ " + parent + " ]");
        ...
        **/
        this.track_scrolls = function(parent) {
            ...
            log(logLevelEnums.INFO, "track_clicks, Starting to track scrolls of the children [ " + parent + " ]");
            var shouldProcess = true;
            var scrollY = 0;
        ...
        **/
        this.track_links = function(parent) {
            parent = parent || document;
            log(logLevelEnums.INFO, "track_links, Starting to track clicks to links from children: [ " + parent + " ]");
            /**
             *  Process click information
             *  @param {Event} event - click event
             */
        ...
        **/
        this.track_forms = function(parent, trackHidden) {
            parent = parent || document;
            log(logLevelEnums.INFO, "track_forms, Starting to track form submissions from children: [ " + parent + " ] ");
            if (trackHidden) {
                log(logLevelEnums.INFO, "track_forms, Also tracking hidden inputs");
            }
            /**
        ...
        **/
        this.collect_from_forms = function(parent, useCustom) {
            parent = parent || document;
            log(logLevelEnums.INFO, "collect_from_forms, Starting to collect possible user data for the children: [ " + parent + " ]");
            if (useCustom) {
                log(logLevelEnums.INFO, "collect_from_forms, Data is submitted as custom user property");
            }
            /**
             *  Process form data
             *  @param {Event} event - form submission event
        ...
        */
        this.initializeRatingWidgets = function(enableWidgets) {
            log(logLevelEnums.INFO, "initializeRatingWidgets, Initializing rating widget");
            if (enableWidgets) {
                log(logLevelEnums.INFO, "initializeRatingWidgets, Initializing the widgets with the widget ID: [ " + enableWidgets + " ]");
            }
            if (!this.check_consent(featureEnums.STAR_RATING)) {
                return;
            }
        ...
        **/
        this.enableRatingWidgets = function(params) {
            log(logLevelEnums.INFO, "enableRatingWidgets, Enabling rating widget");
            if (params) {
                log(logLevelEnums.INFO, "enableRatingWidgets, Provided parameters are: [ " + params + " ]");
        ...
        **/
        this.get_available_feedback_widgets = function(callback) {
            log(logLevelEnums.INFO, "get_available_feedback_widgets, Initializing feedbacks");
            if (callback) {
                log(logLevelEnums.INFO, "get_available_feedback_widgets, Callback function is present");
            }
        ...
        **/
        ...
        /**
         *  Logging stuff, works only when debug mode is 
        ...
        if (typeof str === 'string') {
            if (str.length > limit) {
                ...
                if (debugCondition && typeof console !== "undefined") {
                    // eslint-disable-next-line no-console
                    self.log(logLevelEnums.DEBUG, errorLog + ", Key: [ " + str + " ] is longer than accepted length. It will be truncated.");
                }
            }
        }
        return newStr;
