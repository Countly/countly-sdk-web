    ...
    Countly.show_feedback_popup = function(id) {
        ...
        sendXmlHttpRequest(Countly.url+ '/o/feedback/widget', {app_key:Countly.app_key, widget_id:id}, function(err, params, responseText){
            ...
            try {
                ...
                document.body.innerHTML += '<div id="cfbg"></div><div class="countly-iframe-wrapper" id="countly-iframe-wrapper-'+widget._id+'"><span class="countly-feedback-close-icon" id="countly-feedback-close-icon-'+widget._id+'">×</span><iframe name="countly-feedback-iframe" id="countly-feedback-iframe" src="'+Countly.url+"/feedback?widget_id="+widget._id+"&app_key="+Countly.app_key+'&device_id='+Countly.device_id+'"></iframe></div>';
        ...
        try {
            ...
            xhr.onreadystatechange = function () {
                if (this.readyState === 4 && this.status >= 200 && this.status < 300) {
                    ...
                    if (typeof callback === 'function') { callback(true, params, this.responseText); }
                }
            };
            if(method == "GET")
                xhr.send();
