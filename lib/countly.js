    ...
    var CountlyClass = function(ob) {
        ...
        this.userData = {
            ...
            **/
            increment_by: function(key, value) {
                log(logLevelEnums.INFO, "increment_by, Increasing user's custom property value with key: [ " + key + " ] by: [ " + value + " ] amount  ");
            ...
            **/
            multiply: function(key, value) {
                log(logLevelEnums.INFO, "multiply, Multiplying user's custom property value with key: [ " + key + " ] by: [ " + value + " ] amount ");
        ...
        **/
        this.track_clicks = function(parent) {
            ...
            log(logLevelEnums.INFO, "track_clicks, Starting to track clicks at: [ " + parent + " ]");
        ...
        **/
        this.track_scrolls = function(parent) {
            ...
            log(logLevelEnums.INFO, "track_clicks, Starting to track scrolls at: [ " + parent + " ]");
            var shouldProcess = true;
            var scrollY = 0;
        ...
        **/
        this.track_links = function(parent) {
            parent = parent || document;
            log(logLevelEnums.INFO, "track_links, Starting to track clicks to links at: [ " + parent + " ]");
            /**
             *  Process click information
             *  @param {Event} event - click event
             */
        ...
        **/
        this.track_forms = function(parent, trackHidden) {
            parent = parent || document;
            log(logLevelEnums.INFO, "track_forms, Starting to track form submissions at: [ " + parent + " ] ");
            if (trackHidden) {
        ...
        **/
        this.collect_from_forms = function(parent, useCustom) {
            parent = parent || document;
            log(logLevelEnums.INFO, "collect_from_forms, Starting to collect possible user data at: [ " + parent + " ]");
            if (useCustom) {
        ...
        if (typeof str === 'string') {
            if (str.length > limit) {
                ...
                if (debugCondition && typeof console !== "undefined") {
                    // eslint-disable-next-line no-console
                    console.log(logLevelEnums.DEBUG, errorLog + ", Key: [ " + str + " ] is longer than accepted length. It will be truncated.");
                }
            }
        }
        return newStr;
