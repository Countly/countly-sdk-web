...
(function(root, factory) {
    ...
    */
    ...
    var CountlyClass = function(ob) {
        ...
        this.initialize = function() {
            ...
            document.documentElement.setAttribute("data-countly-useragent", userAgentInfo.ua_raw);
        };
                ...
                try {
                    ...
                    for (var i = 0; i < widgets.length; i++) {
                        if (widgets[i].is_active === "true") {
                            ...
                            var currentDevice = userAgentInfo.detect_device;
                            // device match check
        ...
        * */
        ...
        function checkIgnore() {
            ...
            if (self.ignore_bots && userAgentInfo.is_bot) {
                self.ignore_visitor = true;
            }
        }
        ...
        function getMetrics() {
            ...
            metrics._ua = metrics._ua || userAgentInfo.ua_raw;
    ...
    * */
    ...
    /**
     *  Returns various user agent information
     *  @memberof Countly._internals
     *  @property {string} ua_raw - raw user agent string
     *  @property {boolean} is_bot - if a search bot is reaching the site or not
     *  @property {string} detect_device - current device type (desktop, tablet, phone)
     */
    var userAgentInfo = (function() {
        ...
        // DEVICE TYPE CHECK
        var userAgent = ua_raw.toLowerCase();
        ...
        var is_bot = searchBotRE.test(navigator.userAgent);

        // return information regarding user agent string
        return {
            ua_raw: ua_raw,
            is_bot: is_bot,
