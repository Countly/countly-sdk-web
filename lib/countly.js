...
(function(root, factory) {
    ...
    */
    ...
    var CountlyClass = function(ob) {
        ...
        this.initialize = function() {
            ...
            document.documentElement.setAttribute("data-countly-useragent", ua_raw());
        };
                ...
                try {
                    ...
                    for (var i = 0; i < widgets.length; i++) {
                        if (widgets[i].is_active === "true") {
                            ...
                            var currentDevice = detect_device();
                            // device match check
        ...
        * */
        ...
        function getMetrics() {
            ...
            metrics._ua = metrics._ua || ua_raw();
    ...
    * */
     ...
     *  @returns {string} ua_raw - raw user agent string
     */
    function ua_raw(uaOverride) {
     ...
     *  @memberof Countly._internals
     *  @param {string} uaOverride - a string value to pass instead of ua value
     *  @returns {string} detect_device - current device type (desktop, tablet, phone)
     */
    function detect_device(uaOverride) {
        var userAgent = uaOverride || ua_raw().toLowerCase();
     ...
     *  @memberof Countly._internals
     *  @param {string} uaOverride - a string value to pass instead of ua value
     *  @returns {boolean} is_bot - if a search bot is reaching the site or not
     */
    function is_bot(uaOverride) {
        // search bot regexp
        ...
        return searchBotRE.test(uaOverride || ua_raw());
    }
