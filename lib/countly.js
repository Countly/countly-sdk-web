                    ...
                    if (global && typeof Countly.q !== "undefined" && Countly.q.length > 0) {
                        ...
                        for (i = 0; i < q.length; i++) {
                            ...
                            if (typeof req === "function") {
                                ...
                                if (Countly.i[req[0]]) {
                                    inst = Countly.i[req[0]];
                                }
                                if (typeof inst[req[0]] !== "undefined") {
                                    inst[req[0]].apply(null, req.slice(1));
                                }
                                else if (req[0].indexOf("userData.") === 0) {
                                    var userdata = req[0].replace("userData.", "");
                                    if (typeof inst.userData[userdata] !== "undefined") {
                                        inst.userData[userdata].apply(null, req.slice(1));
                                    }
                                }
                            }
                        }
