        ...
        this.track_sessions = function() {
            ...
            function onchange() {
                if (document[hidden] || !document.hasFocus()) {
                    self.stop_time();
                    log("onchange, stopped time");
                }
                else {
                    self.start_time();
                    log("onchange, started time");
            ...
            if (hidden in document) {
                ...
                log("added visibilitychange");
            }
            else if ((hidden = "mozHidden") in document) {
                document.addEventListener("mozvisibilitychange", onchange);
                log("added mozvisibilitychange");
            }
            else if ((hidden = "webkitHidden") in document) {
                document.addEventListener("webkitvisibilitychange", onchange);
                log("added webkitvisibilitychange");
            }
            else if ((hidden = "msHidden") in document) {
                document.addEventListener("msvisibilitychange", onchange);
                log("added msvisibilitychange");
            }
        ...
        **/
        this.present_feedback_widget = function(presentableFeedback, id, className) {
            ...
            try {
                ...
                var feedbackType = presentableFeedback.type === "rating" ? "ratings" : "surveys";
                ...
                iframe.src = url;
                iframe.name = "countly-" + feedbackType + "-iframe";
                iframe.id = "countly-" + feedbackType + "-iframe";
                ...
                iframe.onload = function() {
                    ...
                    if (initiated) {
                        ...
                        document.getElementById('countly-' + feedbackType + '-wrapper-' + presentableFeedback._id).style.display = "none";
                ...
                var wrapper = document.getElementsByClassName("countly-" + feedbackType + "-wrapper");
                ...
                wrapper.className = 'countly-' + feedbackType + '-wrapper';
                wrapper.id = 'countly-' + feedbackType + '-wrapper-' + presentableFeedback._id;
                ...
                if (presentableFeedback.type === "survey") {
                    ...
                    document.getElementById('countly-' + feedbackType + '-wrapper-' + presentableFeedback._id).style.display = "block";
                    ...
                    switch (presentableFeedback.showPolicy) {
                        case "afterPageLoad":
                            if (document.readyState === "complete") {
                                if (!ratingShown) {
                                    ratingShown = true;
                                    showRating(presentableFeedback);
                                }
                            }
                            else {
                                add_event(document, "readystatechange", function(e) {
            ...
            /**
             * Function to prepare rating sticker and popup
             * @param  {Object} feedback - feedback object
             */
            function showRating(feedback) {
