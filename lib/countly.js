...
(function(root, factory) {
    if (typeof define === "function" && define.amd) {
        define([], function() {
            return factory(root, root.Countly);
        });
    }
    else if (typeof module === "object" && module.exports) {
        module.exports = factory(root, root.Countly);
    }
    else {
        root.Countly = factory(root, root.Countly);
    }
}(typeof window !== "undefined" ? window : this, function(window, Countly) {
    "use strict";
    ...
    **/
    ...
    var detect_device = (function() {
        var b = navigator && navigator.userAgent && navigator.userAgent.toLowerCase(),
            a = function(t) {
                if (t) {
                    b = (t + "").toLowerCase();
                }
