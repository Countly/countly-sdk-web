    ...
    */
    ...
    var CountlyClass = function(ob) {
        ...
        **/
         ...
         *  @param {Boolean} ignoreResultField - ignores the result field, false by default, set it to true to ignore result field check.
         */
        ...
        function isResponseValid(statusCode, str, ignoreResultField) {
            ...
            if (!(statusCode >= 200 && statusCode < 300)) {
                log(logLevelEnums.ERROR, "Http response status code is not acceptable: ", statusCode);
                return false;
            }
