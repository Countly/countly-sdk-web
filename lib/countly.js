...
(function(root, factory) {
    ...
    */
    ...
    var CountlyClass = function(ob) {
        ...
        var lsSupport = true;
        var firstView = null;
        var deviceIdType = DeviceIdTypeInternalEnums.AUTO_GENERATED;
            ...
            if (!offlineMode) {
                ...
                if (ob && Object.keys(ob).length) {
                    if (ob.device_id !== undefined) {
                        deviceIdType = DeviceIdTypeInternalEnums.USER_SET;
                    }
                }
                ...
                deviceIdType = DeviceIdTypeInternalEnums.TEMP_ID;
            }
        ...
        */
        this.get_device_id_type = function() {
            log(logLevelEnums.INFO, "check_device_id_type, Retrieving the current device id.[" + deviceIdType + "]");
            var type;
            switch (deviceIdType) {
            case DeviceIdTypeInternalEnums.AUTO_GENERATED:
                type = self.DeviceIdType.SDK_GENERATED;
                break;
            case DeviceIdTypeInternalEnums.URL_PROVIDED:
            case DeviceIdTypeInternalEnums.USER_SET:
                type = self.DeviceIdType.DEVELOPER_SUPPLIED;
                break;
            case DeviceIdTypeInternalEnums.TEMP_ID:
        ...
        */
        ...
        this.disable_offline_mode = function(device_id) {
            ...
            if (device_id && this.device_id !== device_id) {
                ...
                deviceIdType = DeviceIdTypeInternalEnums.USER_SET;
                store("cly_id", this.device_id);
                store("cly_id_type", DeviceIdTypeInternalEnums.USER_SET);
                ...
                if (this.device_id !== store("cly_id")) {
                    store("cly_id", this.device_id);
                    store("cly_id_type", DeviceIdTypeInternalEnums.AUTO_GENERATED);
                }
            }
        ...
        * */
        this.change_id = function(newId, merge) {
            ...
            if (offlineMode) {
                ...
                self.disable_offline_mode(newId);
                return;
            }
    ...
    * */
    ...
    Countly.DeviceIdType = {
        DEVELOPER_SUPPLIED: DeviceIdTypeInternalEnums.USER_SET,
        SDK_GENERATED: DeviceIdTypeInternalEnums.AUTO_GENERATED,
        TEMPORARY_ID: DeviceIdTypeInternalEnums.TEMP_ID
    };
    return Countly;
}));
