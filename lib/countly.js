    ...
    var CountlyClass = function(ob) {
        ...
        **/
        this.start_event = function(key) {
            log(logLevelEnums.INFO, "start_event, Starting timed event");
        ...
        this.userData = {
            ...
            **/
            set: function(key, value) {
                log(logLevelEnums.INFO, "set, Setting user's custom property value");
            ...
            **/
            unset: function(key) {
                log(logLevelEnums.INFO, "unset, Resetting user's custom property value");
                customData[key] = "";
            },
            /**
            ...
            **/
            set_once: function(key, value) {
                log(logLevelEnums.INFO, "set_once, Setting user's unique custom property value");
                //truncate user's custom property value to internal limits
            ...
            **/
            increment: function(key) {
                log(logLevelEnums.INFO, "increment, Increasing user's custom property value");
            ...
            **/
            increment_by: function(key, value) {
                log(logLevelEnums.INFO, "increment_by, Increasing user's custom property value");
            ...
            **/
            multiply: function(key, value) {
                log(logLevelEnums.INFO, "multiply, Multiplying user's custom property value");
            ...
            **/
            max: function(key, value) {
                log(logLevelEnums.INFO, "max, Saving user's max custom property value");
                //truncate key value pair wrt internal limits
            ...
            **/
            min: function(key, value) {
                log(logLevelEnums.INFO, "min, Saving user's min custom property value");
                //truncate key value pair wrt internal limits
            ...
            **/
            push: function(key, value) {
                log(logLevelEnums.INFO, "push, Pushing a value to user's custom property array");
                //truncate key value pair wrt internal limits
            ...
            **/
            push_unique: function(key, value) {
                log(logLevelEnums.INFO, "push_unique, Pushing a unique value to user's custom property array");
                //truncate key value pair wrt internal limits
            ...
            **/
            pull: function(key, value) {
                log(logLevelEnums.INFO, "pull, Removing a value from user's custom property array");
        ...
        **/
        this.add_log = function(record) {
            log(logLevelEnums.INFO, "add_log, Adding a new log of breadcrumb");
        ...
        **/
        this.track_forms = function(parent, trackHidden) {
            log(logLevelEnums.INFO, "track_forms, Starting to track form submissions");
            parent = parent || document;
            /**
        ...
        **/
        this.collect_from_forms = function(parent, useCustom) {
            log(logLevelEnums.INFO, "collect_from_forms, Starting to collect possible user data");
            parent = parent || document;
            /**
             *  Process form data
             *  @param {Event} event - form submission event
        ...
        **/
        this.recordRatingWidgetWithID = function(ratingWidget) {
            log(logLevelEnums.INFO, "recordRatingWidgetWithID, Providing information about user");
        ...
        */
        this.presentRatingWidgetWithID = function(id) {
            log(logLevelEnums.INFO, "presentRatingWidgetWithID, Showing rating widget popup");
            if (!this.check_consent(featureEnums.STAR_RATING)) {
                return;
            }
            if (offlineMode) {
        ...
        **/
        this.present_feedback_widget = function(presentableFeedback, id, className) {
            log(logLevelEnums.INFO, "present_feedback_widget, Presenting the feedback widget");
            if (!this.check_consent(featureEnums.FEEDBACK)) {
                return;
            }
        ...
        function log(level, message, ...args) {
            if (self.debug && typeof console !== "undefined") {
                ...
                if (level === logLevelEnums.ERROR) {
                    ...
                    if (level !== logLevelEnums.DEBUG || level !== logLevelEnums.VERBOSE) {
