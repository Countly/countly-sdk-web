 ...
 */
    ...
    **/
    Countly.track_sessions = function(){
        ...
        function resetInactivity(){
            console.log("resetting activity", inactivityCounter, inactivityTime);
        ...
        setInterval(function(){
            ...
            console.log("increasing activity", inactivityCounter, inactivityTime);
        }, 60000);
    };
    ...
    * @param {string=} page - optional name of the page, by default uses current url path
    **/
    Countly.track_view = function(page){
        Countly.track_pageview(page);
    };
