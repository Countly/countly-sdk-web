    ...
    function sendXmlHttpRequest(url, params, callback) {
        try {
            ...
            if(data.length >= 2000)
                ...
                method = "POST";
            if(method === "GET") {
                if (Object.keys(params).length > 0) xhr.open('GET', url + "?" + data, true);
