...
(function(root, factory) {
    ...
    */
    ...
    var CountlyClass = function(ob) {
        ...
        var lsSupport = true;
        var firstView = null;
        var deviceIdType = deviceIdTypeEnums.autoGenerated;
            ...
            if (!offlineMode) {
                ...
                if (ob && Object.keys(ob).length) {
                    if (ob.device_id !== undefined) {
                        deviceIdType = deviceIdTypeEnums.userSet;
                    }
                }
                ...
                deviceIdType = deviceIdTypeEnums.tempId;
                log(logLevelEnums.WARNING, "1-ID change", deviceIdType);
            }
            ...
            if (!this.ignore_visitor) {
                ...
                if (location.search) {
                    ...
                    for (var i = 0; i < parts.length; i++) {
                        ...
                        if (nv[0] === "cly_id") {
                            ...
                            this.device_id = nv[1];
                            deviceIdType = deviceIdTypeEnums.urlProvided;
                            log(logLevelEnums.WARNING, "2-ID change", deviceIdType);
                        }
                ...
                if (!offlineMode) {
                    if (this.device_id !== store("cly_id")) {
                        ...
                        store("cly_id_type", deviceIdType);
                    }
                }
        ...
        */
        this.check_device_id_type = function() {
            log(logLevelEnums.INFO, "check_device_id_type, Checking the current device id type");
            if (deviceIdType === deviceIdTypeEnums.urlProvided) {
                return deviceIdTypeEnums.userSet;
            }
            return deviceIdType;
        };
        ...
        */
        ...
        this.enable_offline_mode = function() {
            ...
            this.device_id = "[CLY]_temp_id";
            deviceIdType = deviceIdTypeEnums.tempId;
            log(logLevelEnums.WARNING, "3-ID change", deviceIdType);
        };
        ...
        this.disable_offline_mode = function(device_id) {
            ...
            if (device_id && this.device_id !== device_id) {
                ...
                deviceIdType = deviceIdTypeEnums.userSet;
                log(logLevelEnums.WARNING, "4-ID change", deviceIdType);
                store("cly_id", this.device_id);
                store("cly_id_type", deviceIdTypeEnums.userSet);
                ...
                if (this.device_id !== store("cly_id")) {
                    store("cly_id", this.device_id);
                    store("cly_id_type", deviceIdTypeEnums.autoGenerated);
                }
            }
        ...
        * */
        this.change_id = function(newId, merge) {
            ...
            if (this.device_id !== newId) {
                ...
                deviceIdType = deviceIdTypeEnums.userSet;
                log(logLevelEnums.WARNING, "5-ID change", deviceIdType);
                store("cly_id", this.device_id);
                store("cly_id_type", deviceIdTypeEnums.userSet);
        ...
        * */
        ...
        function prepareRequest(request) {
            ...
            // device ID type information 22.02.0
        ...
        function getId() {
            if (store("cly_id")) {
                deviceIdType = store("cly_id_type");
                log(logLevelEnums.WARNING, "6-ID change", deviceIdType);
            }
        ...
        function migrate() {
            if (store(self.namespace + "cly_id", undefined, false, true)) {
                ...
                store("cly_id_type", store(self.namespace + "cly_id_type", undefined, false, true));
                ...
                store("cly_id_type", null, false, true);
        ...
        this.onStorageChange = function(key, newValue) {
            ...
            case "cly_id_type":
                ...
                log(logLevelEnums.WARNING, "7-ID change", deviceIdType);
                break;
            default:
                    // do nothing
            }
