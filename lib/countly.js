...
(function (root, factory) {
    ...
    */
     ...
     */
    Countly.initializeFeedbackPopups = function(enableWidgets) {
        if (!enableWidgets) enableWidgets = store('cly_fb_widgets');
    ...
    Countly.enable_feedback = function(params) {
        if (offlineMode) {
            ...
            if (enableWidgets.length > 0) {
                ...
                Countly.initializeFeedbackPopups(enableWidgets);
            } else {
    ...
    **/
    ...
    function processWidget(currentWidget, hasSticker){
        ...
        while (stickers.length > 0) stickers[0].remove();
