...
(function(root, factory) {
    ...
    * */
    ...
    function currentUserAgentString(uaOverride) {
        ...
        // check if userAgentData is supported and use it instead
        if (navigator.userAgentData) {
            ...
            // add mobile info
            ua_raw += (navigator.userAgentData.mobile ? " mobile:true " : " mobile:false ");
            // add platform info
            ua_raw += navigator.userAgentData.platform;
        }
        // RAW USER AGENT STRING
        return uaOverride || ua_raw;
    }
    ...
    function userAgentDeviceDetection(uaOverride) {
        ...
        var device = "phone";
        // if userAgentData is (available and mobile is false), or (not available) at all do further investigation
