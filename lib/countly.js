    ...
    var CountlyClass = function(ob) {
        ...
        **/
        this.track_forms = function(parent, trackHidden) {
            log(logLevelEnums.INFO, "track_forms, Starting to track form submissions. DOM object which children to track is provided: [ " + parent ? true: false + " ] Tracking hidden inputs is: [ " + trackHidden ? true : false + " ]");
            parent = parent || document;
            /**
        ...
        **/
        this.collect_from_forms = function(parent, useCustom) {
            log(logLevelEnums.INFO, "collect_from_forms, Starting to collect possible user data. DOM object which children to track is provided: [ " + parent ? true: false + " ] Submitting data as custom user property is: [ " + useCustom ? true : false + " ]" );
            parent = parent || document;
            /**
             *  Process form data
             *  @param {Event} event - form submission event
        ...
        **/
        this.enableRatingWidgets = function(params) {
            log(logLevelEnums.INFO, "enableRatingWidgets, Enabling rating widget with provided parameters:", params);
            if (!this.check_consent(featureEnums.STAR_RATING)) {
                return;
            }
            if (offlineMode) {
