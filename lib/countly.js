...
(function (root, factory) {
    ...
    Countly.init = function (ob, requireConsent) {
        if (!inited) {
            ...
            useSessionCookie = ob.use_session_cookie || Countly.use_session_cookie || useSessionCookie;
            sessionCookieTimeout = ob.session_cookie_timeout || Countly.session_cookie_timeout || sessionCookieTimeout;
