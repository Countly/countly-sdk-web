...
(function(root, factory) {
    ...
    */
    ...
    var CountlyClass = function(ob) {
        ...
        * @param {Object} widgetResponse - it is the widget results that need to be reported, different for all widgets, if provided as null it means the widget was closed
        * widgetResponse For NPS
        * Should include rating and comment from the nps. Example:
        * widgetResponse = {rating: 3, comment: "comment"}
        * 
        * widgetResponse For Survey
        ...
        *   }
        * 
        * widgetResponse For Rating Widget
        ...
        *   }
        * */
        this.reportFeedbackWidgetManually = function(CountlyFeedbackWidget, CountlyWidgetData, widgetResponse) {
            ...
            if (!CountlyFeedbackWidget._id) {
                log(logLevelEnums.ERROR, "reportFeedbackWidgetManually, Feedback Widgets must contain widget_id property");
                return;
            }
            if (offlineMode) {
            ...
            if (type === "nps") {
                if (widgetResponse) {
                    if (!widgetResponse.rating) {
                        log(logLevelEnums.ERROR, "reportFeedbackWidgetManually, Widget must contain rating property");
                        return;
                    }
                    widgetResponse.rating = Math.round(widgetResponse.rating);
                    if (widgetResponse.rating > 10) {
            ...
            if (widgetResponse === null) {
                ...
                event.segmentation = addNewProperties(event.segmentation, widgetResponse, props);
            }
        ...
        */
        this._internals = {
            ...
            add_event: add_event,
            getProperties: createNewObjectFromProperties,
    ...
    * */
    ...
    /**
     *  Add specified properties to an object from another bject
     *  @memberof Countly._internals
     *  @param {Object} orig - original object
