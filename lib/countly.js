        ...
        this.initialize = function() {
            ...
            // if not check if offline mode is on
                ...
                if (offlineMode && !tempIdModeWasEnabled) {
                    log(logLevelEnums.INFO, "initialize, Temp ID set");
                }
                else if (offlineMode && tempIdModeWasEnabled) {
                    log(logLevelEnums.INFO, "initialize, Continuing offline mode from previous app session");
                }
                else {
                    offlineMode = true;
                    log(logLevelEnums.INFO, "initialize, Enabling offline mode with respect to the previous app session");
                }
            }
