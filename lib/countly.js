...
(function(root, factory) {
    ...
    */
        ...
        this.initialize = function() {
            ...
            if (!this.ignore_visitor) {
                ...
                setTimeout(function() {
                    ...
                    if (self.remote_config && !self.check_consent("remote-config")) {
                        log("Using Remote config without consent will be deprecated by 2022. Please set the remote-config consent explicitly.");
                        Countly.add_consent("remote-config");
                    }

                    if (self.check_consent("remote-config")) {
     ...
     * @param {boolean|function} [conf.remote_config=false] - Deprecated: Enable automatic remote config fetching, provide callback function to be notified when fetching done
