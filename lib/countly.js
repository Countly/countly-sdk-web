...
(function(root, factory) {
     ...
     */
    var sessionsFeature = "sessions";
    var eventsFeature = "events";
    var viewsFeature = "views";
    var scrollsFeature = "scrolls";
    var clicksFeature = "clicks";
    var formsFeature = "forms";
    var crashesFeature = "crashes";
    var attributionFeature = "attribution";
    var usersFeature = "users";
    var starRatingFeature = "star-rating";
    var locationFeature = "location";
    var apmFeature = "apm";
    var feedbackFeature = "feedback";
    var remoteConfigFeature = "remote-config";
    Countly.features = [sessionsFeature, eventsFeature, viewsFeature, scrollsFeature, clicksFeature, formsFeature, crashesFeature, attributionFeature, usersFeature, starRatingFeature, locationFeature, apmFeature, feedbackFeature, remoteConfigFeature];
     ...
     */
    var internalNps = '[CLY]_nps';
    var internalSurvey = '[CLY]_survey';
    var internalStar = '[CLY]_star_rating';
    var internalView = '[CLY]_view';
    var internalOrient = '[CLY]_orientation';
    var internalPush = '[CLY]_push_action';
    var internalAction = '[CLY]_action';
        ...
        **/
        this.change_id = function(newId, merge) {
            if (!newId || typeof newId !== 'string' || newId.length === 0) {
                log("change_id: The provided ID: " + newId + " is not a valid ID");
                return;
            }
