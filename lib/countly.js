...
(function (Countly) {
	...
	**/
    ...
    Countly.track_clicks = function(){
                ...
                if(typeof event.pageX !== "undefined" && typeof event.pageY !== "undefined"){
                    ...
                    Countly.add_event({
                        ...
                        "segmentation": {
                            ...
                            "width":width,
                            "height":height,
                            "rx": parseInt(event.pageX)/width,
                            "ry": parseInt(event.pageY)/height
                        }
                    });
                }
        ...
        add_event(document.body, "mousedown", processClick);
        add_event(document.body, "mouseup", processClick);
        add_event(document.body, "click", processClick);
    };
