    ...
    */
    ...
    var CountlyClass = function(ob) {
        ...
        this.halt = function() {
            ...
            Countly.onload = undefined;
            Countly.utm = undefined;
            Countly.ignore_prefetch = undefined;
            Countly.debug = undefined;
            Countly.test_mode = undefined;
            Countly.tests = undefined;
            Countly.metrics = undefined;
            Countly.headers = undefined;
            ...
            Countly.ignore_bots = undefined;
            Countly.force_post = undefined;
            Countly.remote_config = undefined;
            Countly.ignore_visitor = undefined;
            Countly.require_consent = undefined;
            Countly.track_domains = undefined;
            Countly.storage = undefined;
            Countly.enableOrientationTracking = undefined;
            Countly.maxKeyLength = undefined;
            Countly.maxValueSize = undefined;
            Countly.maxSegmentationValues = undefined;
            Countly.maxBreadcrumbCount = undefined;
            Countly.maxStackTraceLinesPerThread = undefined;
            Countly.maxStackTraceLineLength = undefined;
        };
        ...
        * */
         ...
         */
        function sendXmlHttpRequest(functionName, url, params, callback, ignoreResultField = false) {
            try {
        ...
        this.onStorageChange = function(key, newValue) {
            log(logLevelEnums.INFO, `onStorageChange, Applying storage changes for key: [${key}] and newValue: [${newValue}]`);
            switch (key) {
            // queue of requests
            case "cly_queue":
    ...
    * */
    ...
    var detect_device = (function() {
        ...
        var a = function(t) {
            ...
            const tabletCheck = /(ipad|tablet|(android(?!.*mobile))|(windows(?!.*phone)(.*touch))|kindle|playbook|silk|(puffin(?!.*(IP|AP|WP))))/;
            const phoneCheck = /(mobi|ipod|phone|blackberry|opera mini|fennec|minimo|symbian|psp|nintendo ds|archos|skyfire|puffin|blazer|bolt|gobrowser|iris|maemo|semc|teashark|uzard)/;
            var device = "desktop";
