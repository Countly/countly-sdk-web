    ...
    */
    ...
    var CountlyClass = function(ob) {
        ...
        this.initialize = function() {
            ...
            log(logLevelEnums.INFO, "initialize, app_key:[" + this.app_key + "]");
            log(logLevelEnums.INFO, "initialize, url:[" + this.url + "]");
            log(logLevelEnums.INFO, "initialize, device_id:[" + getConfig("device_id", ob, undefined) + "]");
            log(logLevelEnums.INFO, "initialize, require_consent:[" + this.require_consent + "]");
            log(logLevelEnums.INFO, "initialize, metrics:[" + this.metrics + "]");
            log(logLevelEnums.INFO, "initialize, headers:[" + this.headers + "]");
            log(logLevelEnums.INFO, "initialize, app_version:[" + this.app_version + "]");
            // location info printed here
            log(logLevelEnums.INFO, "initialize, country_code:[" + this.country_code + "]");
            log(logLevelEnums.INFO, "initialize, city:[" + this.city + "]");
            log(logLevelEnums.INFO, "initialize, ip_address:[" + this.ip_address + "]");
            ...
            if (this.onload) {
                log(logLevelEnums.INFO, "initialize, onload:[" + this.onload + "]");
            }
            ...
            if (this.utm !== { source: true, medium: true, campaign: true, term: true, content: true }) {
                log(logLevelEnums.INFO, "initialize, utm:[" + this.utm + "]");
            }
            ...
            if (ignoreReferrers) {
                log(logLevelEnums.INFO, "initialize, ignore_referrers:[" + ignoreReferrers + "]");
            }
            if (this.force_post) {
            ...
            if (offlineMode) {
                log(logLevelEnums.WARNING, "initialize, offline_mode:[" + offlineMode + "], user info won't be send to the servers");
            }
