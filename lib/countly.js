...
(function(root, factory) {
    ...
    */
    ...
    var CountlyClass = function(ob) {
        ...
        * @param {string} newId - new user/device ID to use, must be a non-empty string value, other falsy values (like null. empty string or undefined) will be rejected
        * @param {boolean} merge - move data from old ID to new ID on server
        **/
        this.change_id = function(newId, merge) {
            if (!newId || typeof newId !== 'string' || newId === '') {
