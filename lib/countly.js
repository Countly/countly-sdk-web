...
(function(root, factory) {
    ...
    */
     ...
     * @param {String} boomSrc - BoomerangJS script directory. If not provided latest CDN source used. Supported version is 1.0.0
     * @param {String} clyBoomSrc - Countly's BoomerangJS script directory. If not provided latest CDN source used.
     */
    Countly.initWithAPM = function(boomSrc, clyBoomSrc) {
        // Set boomerang script source either locally or from CDN
        boomSrc = boomSrc || "https://cdn.jsdelivr.net/npm/countly-sdk-web@latest/plugin/boomerang/boomerang.min.js";
        clyBoomSrc = clyBoomSrc || "https://cdn.jsdelivr.net/npm/countly-sdk-web@latest/plugin/boomerang/countly_boomerang.js";
