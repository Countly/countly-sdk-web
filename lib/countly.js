...
(function (root, factory) {
     ...
     */
    Countly.features = ["sessions", "events", "views", "scrolls", "clicks", "forms", "crashes", "attribution", "users", "star-rating", "location", "apm", "feedback"];
        ...
        try {
            ...
            iframe.onload = function() {
                ...
                if (initiated) {
                    ...
                    document.getElementById('countly-surveys-wrapper-' + presentableFeedback._id).remove();
                    document.getElementById('csbg').remove();
                }
