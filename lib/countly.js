...
(function(root, factory) {
    ...
    */
    ...
    var CountlyClass = function(ob) {
        ...
        this.initialize = function() {
            ...
            this.expectedBoomVersion = Countly.expectedBoomVersion; // it is to show which version of boomerang is expected for our boomerang script
            this.boomScriptVersion = Countly.boomScriptVersion; // it is countly_boomerang version that SDK is looking for
    ...
    * */
    ...
    /**
    * Expected Boomerang version for countly_boomerang script
    * @enum expectedBoomVersion
    * */
    Countly.expectedBoomVersion = "1.737.0";

    /**
    * Expected countly_boomerang script version
    * @enum boomScriptVersion
    * */
    Countly.boomScriptVersion = "1";
    return Countly;
}));
