    ...
    Countly.show_feedback_popup = function(id) {
        ...
        sendXmlHttpRequest(Countly.url+ '/o/feedback/widget', {app_key:Countly.app_key, widget_id:id}, function(err, params, responseText){
            ...
            try {
                ...
                // create feedback sticker element
                ...
                sticker.innerHTML = currentWidget.trigger_button_text;
                // create wrapper div
                                ...
                                if (pages[k] === window.location.pathname && !widgets[i].hide_sticker) {
                                    (function(currentWidget) { 
                                        try {
                                            ...
                                            sticker.className = 'countly-feedback-sticker '+ currentWidget.trigger_position;
                                            sticker.id = 'countly-feedback-sticker-'+currentWidget._id;
                                            sticker.innerHTML = '<img src="'+Countly.url+'/star-rating/images/star-rating/grin-regular.svg" class="feedback-sticker-svg"/>' + currentWidget.trigger_button_text;
                                            // create wrapper div
                                            var wrapper = document.createElement("div");
                                            wrapper.className = 'countly-iframe-wrapper';
                                            wrapper.id = 'countly-iframe-wrapper-'+currentWidget._id;
                                        ...
                                        setTimeout(function() {
                                            add_event(document.getElementById('countly-feedback-sticker-'+currentWidget._id), 'click', function(){document.getElementById('countly-iframe-wrapper-'+currentWidget._id).style.display = "block";document.getElementById('cfbg').style.display = "block";});
                                            add_event(document.getElementById('countly-feedback-close-icon-'+currentWidget._id), 'click', function(){document.getElementById('countly-iframe-wrapper-'+currentWidget._id).style.display = "none";document.getElementById('cfbg').style.display = "none";});
                                        },1);
                                    })(widgets[i]);
                                }
                            }
