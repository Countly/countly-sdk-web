            ...
            try {
                ...
                if (id) {
                    if (document.getElementById(id)) {
                        document.getElementById(id).insertAdjacentHTML('beforeend', '<div id="csbg"></div>');
                    ...
                    if (document.getElementsByClassName(className)[0]) {
                        document.getElementsByClassName(className)[0].insertAdjacentHTML('beforeend', '<div id="csbg"></div>');
                        document.getElementsByClassName(className)[0].appendChild(wrapper);
                        appended = true;
                    }
                    else {
