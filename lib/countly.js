    ...
    */
    ...
    var CountlyClass = function(ob) {
        ...
        this.initialize = function() {
            ...
            self.hcErrorCount = getValueFromStorage("cly_hc_error_count") || 0;
            self.hcWarningCount = getValueFromStorage("cly_hc_warning_count") || 0;
            self.hcStatusCode = getValueFromStorage("cly_hc_status_code") || 0;
            self.hcErrorMessage = getValueFromStorage("cly_hc_error_message") || "";
        ...
        function log(level, message) {
            if (self.debug && typeof console !== "undefined") {
                ...
                if (level === logLevelEnums.ERROR) {
                    ...
                    console.error(log);
                    self.hcErrorCount++;
                    setValueInStorage("cly_hc_error_count", self.hcErrorCount);
                }
                else if (level === logLevelEnums.WARNING) {
                    // eslint-disable-next-line no-console
                    console.warn(log);
                    self.hcWarningCount++;
                    setValueInStorage("cly_hc_warning_count", self.hcWarningCount);
                }
