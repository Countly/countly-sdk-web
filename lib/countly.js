...
(function(root, factory) {
    ...
    */
     ...
     * conf.boomSrc - BoomerangJS script directory. If not provided latest CDN source used. Supported version is 1.0.0
     * conf.clyBoomSrc - Countly's BoomerangJS script directory. If not provided latest CDN source used.
     * @param {Object} conf - Countly's BoomerangJS script directory. If not provided latest CDN source used.
     */
    function initAfterAPM(conf) {
        // Set boomerang script source either locally or from CDN
        var boomSrc = conf.boomSrc || "https://cdn.jsdelivr.net/npm/countly-sdk-web@latest/plugin/boomerang/boomerang.min.js";
        var clyBoomSrc = conf.clyBoomSrc || "https://cdn.jsdelivr.net/npm/countly-sdk-web@latest/plugin/boomerang/countly_boomerang.js";
        ...
        boomerangScript.src = boomSrc;
        countlyBoomerangScript.src = clyBoomSrc;
