    ...
    */
    ...
    var CountlyClass = function(ob) {
        ...
        * */
        ...
        function sendXmlHttpRequest(url, params, callback) {
            try {
                ...
                xhr.onreadystatechange = function() {
                    if (isResponseValid(this.readyState, this.status, this.responseText)) {
                        if (typeof callback === 'function') {
         ...
         * @memberof Countly._internals
         * @param {Number} readyState - http incoming readyState.
         ...
         */
        function isResponseValid(readyState, statusCode, str) {
            // status code and response format check
            if (!(statusCode >= 200 && statusCode < 300 && readyState === 4)) {
                return false;
            }
