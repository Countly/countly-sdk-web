(function(b){function I(){if(x){w||y();var a={name:x,segment:w};b.add_event({key:"[CLY]_view",dur:j()-z,segmentation:a});x=null}}function n(a){if(!b.ignore_bots||!J)if(!b.app_key||!b.device_id)f("app_key or device_id is missing");else{a.app_key=b.app_key;a.device_id=b.device_id;b.country_code&&(a.country_code=b.country_code);b.city&&(a.city=b.city);null!==b.ip_address&&(a.ip_address=b.ip_address);a.timestamp=j();var e=new Date;a.hour=e.getHours();a.dow=e.getDay();r.push(a);l("cly_queue",r,!0)}}function B(){if("undefined"!==
typeof b.q&&0<b.q.length){for(var a,e=0;e<b.q.length;e++)if(a=b.q[e],f("Processing queued call",a),"function"===typeof a)a();else if(a.constructor===Array&&0<a.length)if("undefined"!==typeof b[a[0]])b[a[0]].apply(null,a.slice(1));else{var d=a[0].replace("userData.","");"undefined"!==typeof b.userData[d]&&b.userData[d].apply(null,a.slice(1))}b.q=[]}u&&(K&&C)&&(a=j(),60<a-t&&(b.session_duration(a-t),t=a));0<v.length&&(10>=v.length?(n({events:JSON.stringify(v)}),v=[]):(a=v.splice(0,10),n({events:JSON.stringify(a)})));
if(0<r.length&&D&&j()>L){D=!1;var c=r.shift();f("Processing request",c);var g=function(a,e){f("Request Finished",e,a);a&&(r.unshift(e),l("cly_queue",r,!0),L=j()+E);D=!0};try{f("Sending XML HTTP request");var m=window.XMLHttpRequest?new window.XMLHttpRequest:window.ActiveXObject?new ActiveXObject("Microsoft.XMLHTTP"):null;m.open("GET",b.url+V+"?"+W(c),!0);m.onreadystatechange=function(){4===this.readyState&&200<=this.status&&300>this.status?"function"===typeof g&&g(!1,c):4===this.readyState&&(f("Failed Server XML HTTP request",
...
typeof e&&(a._locale=e);if("undefined"!==typeof document.referrer&&document.referrer.length&&(e=N.exec(document.referrer))&&e[11]&&e[11]!=window.location.hostname)a._store=document.referrer;f("Got metrics",a);return a}function f(){b.debug&&"undefined"!==typeof console&&(arguments[1]&&"object"==typeof arguments[1]&&(arguments[1]=JSON.stringify(arguments[1])),console.log(Array.prototype.slice.call(arguments).join("\n")))}function j(){return Math.floor((new Date).getTime()/1E3)}function G(a,e,b){var b=
b||O,c="";"object"===typeof a?"undefined"!==typeof a.stack?c=a.stack:("undefined"!==typeof a.name&&(c+=a.name+":"),"undefined"!==typeof a.message&&(c+=a.message+"\n"),"undefined"!==typeof a.fileName&&(c+="in "+a.fileName+"\n"),"undefined"!==typeof a.lineNumber&&(c+="on "+a.lineNumber),"undefined"!==typeof a.columnNumber&&(c+=":"+a.columnNumber)):c=a+"";var e=e?!0:!1,a=y(),c={_os:a._os,_os_version:a._os_version,_resolution:a._resolution,_error:c,_app_version:a._app_version,_run:j()-P,_not_os_specific:!0},
...
t=j(),u=!0,K=a?!1:!0,a={begin_session:1},a.metrics=JSON.stringify(y()),n(a))};b.session_duration=function(a){u&&(f("Session extended",a),n({session_duration:a}))};b.end_session=function(a){u&&(a=a||j()-t,f("Ending session"),I(),u=!1,n({end_session:1,session_duration:a}),B())};b.change_id=function(a,e){var d=b.device_id;b.device_id=a;l("cly_id",b.device_id);f("Changing id");e&&n({old_device_id:d})};b.add_event=function(a){if(a.key){a.count||(a.count=1);var b=Q(a,["key","count","sum","dur","segmentation"]);
...
a);n({user_details:JSON.stringify(Q(a,"name username email organization phone picture gender byear custom".split(" ")))})};var p={},q=function(a,b,d){p[a]||(p[a]={});"$push"==d||"$pull"==d||"$addToSet"==d?(p[a][d]||(p[a][d]=[]),p[a][d].push(b)):p[a][d]=b};b.userData={set:function(a,b){p[a]=b},set_once:function(a){q(a,1,"$setOnce")},increment:function(a){q(a,1,"$inc")},increment_by:function(a,b){q(a,b,"$inc")},multiply:function(a,b){q(a,b,"$mul")},max:function(a,b){q(a,b,"$max")},min:function(a,b){q(a,
b,"$min")},push:function(a,b){q(a,b,"$push")},push_unique:function(a,b){q(a,b,"$addToSet")},pull:function(a,b){q(a,b,"$pull")},save:function(){n({user_details:JSON.stringify({custom:p})});p={}}};b.track_errors=function(a){O=a;window.onerror=function(a,b,c,g,m){if("undefined"!==typeof m)G(m,!1);else{var g=g||window.event&&window.event.errorCharacter,i="";"undefined"!==typeof a&&(i+=a+"\n");"undefined"!==typeof b&&(i+="at "+b);"undefined"!==typeof c&&(i+=":"+c);"undefined"!==typeof g&&(i+=":"+g);i+=
"\n";try{for(var f=[],h=arguments.callee.caller;h;)f.push(h.name),h=h.caller;i+=f.join("\n")}catch(j){}G(i,!1)}}};b.log_error=function(a,b){G(a,!0,b)};b.add_log=function(a){A.push(a)};b.stop_time=function(){C=!1;T=j()-t;H=j()-z};b.start_time=function(){C=!0;t=j()-T;z=j()-H;H=0};b.track_sessions=function(){function a(){document[e]?b.stop_time():b.start_time()}b.begin_session();b.start_time();k(window,"beforeunload",function(){b.end_session()});k(window,"unload",function(){b.end_session()});var e="hidden";
...
k(window,"pageshow",function(){b.start_time()}),k(window,"pagehide",function(){b.stop_time()}))};b.track_pageview=function(a){I();x=a=a||window.location.pathname;z=j();w||y();a={name:a,visit:1,segment:w,domain:window.location.hostname};if("undefined"!==typeof document.referrer&&document.referrer.length){var e=N.exec(document.referrer);e&&(e[11]&&e[11]!=window.location.hostname)&&(a.start=1)}b.add_event({key:"[CLY]_view",segmentation:a})};b.track_clicks=function(){function a(a){if(e){e=!1;R(a);if("undefined"!==
