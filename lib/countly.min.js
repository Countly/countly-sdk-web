...
[]):(a=t.splice(0,G),r({events:JSON.stringify(a)})),q("cly_event",t));if(0<s.length&&N&&l()>U){N=!1;var e=s.shift();m("Processing request",e);var j=function(a,c){m("Request Finished",c,a);a&&(s.unshift(c),U=l()+O);q("cly_queue",s,!0);N=!0};try{m("Sending XML HTTP request");var h=window.XMLHttpRequest?new window.XMLHttpRequest:window.ActiveXObject?new ActiveXObject("Microsoft.XMLHTTP"):null,i;a=[];for(var g in e)a.push(g+"="+encodeURIComponent(e[g]));i=a.join("&");g="GET";2E3<=i.length?g="POST":b.force_post&&
(g="POST");"GET"===g?h.open("GET",b.url+V+"?"+i,!0):(h.open("POST",b.url+V,!0),h.setRequestHeader("Content-type","application/x-www-form-urlencoded"));h.onreadystatechange=function(){4===this.readyState&&200<=this.status&&300>this.status?"function"===typeof j&&j(!1,e):4===this.readyState&&(m("Failed Server XML HTTP request",this.status),"function"===typeof j&&j(!0,e))};"GET"==g?h.send():h.send(i)}catch(d){m("Failed XML HTTP request",d),"function"===typeof j&&j(!0,e)}}setTimeout(L,P)}function D(){var a=
{};a._app_version=b.app_version;screen.width&&(a._resolution=""+(screen.width?screen.width:"")+"x"+(screen.height?screen.height:""));for(var c=navigator.appVersion,f=navigator.userAgent,e=navigator.appName,j,h,i=[["Opera Mini","Opera Mini"],["Opera","Opera"],["OPR","Opera"],["MSIE","Internet Explorer"],["IEMobile","IE Mobile"],["Edge","Edge"],["CrKey","Chromecast"],["Chromium","Chromium"],["FxiOS","Firefox"],["Trident","Internet Explorer"],["FBAV/","Facebook app"],["baiduboxapp/","Baidu Box App"],
...
["iCab","iCab"],["iTunes","iTunes"],["rekonq","rekonq"],["rekonq","rekonq"],["Chrome","Chrome"],["Firefox","Firefox"],["Android","Android"],["Safari","Safari"],["iPhone","Safari"]],g=0;g<i.length;g++)if(-1!=f.indexOf(i[g][0])){e=i[g][1];break}if(!e&&(j=f.lastIndexOf(" ")+1)<(h=f.lastIndexOf("/")))e=f.substring(j,h),e.toLowerCase()==e.toUpperCase()&&(e=navigator.appName);a._browser=e;var g="unknown",e=[{s:"Xbox",r:/Xbox/},{s:"Windows 3.11",r:/Win16/},{s:"Windows 95",r:/(Windows 95|Win95|Windows_95)/},
...
r:/(Windows NT 4.0|WinNT4.0|WinNT|Windows NT)/},{s:"Windows ME",r:/Windows ME/},{s:"Windows Phone",r:/Windows Phone/},{s:"Android",r:/Android/},{s:"Open BSD",r:/OpenBSD/},{s:"Sun OS",r:/SunOS/},{s:"Linux",r:/(Linux|X11)/},{s:"iOS",r:/(iPhone|iPad|iPod)/},{s:"Mac OSX",r:/Mac OS X/},{s:"Mac OS",r:/(MacPPC|MacIntel|Mac_PowerPC|Macintosh)/},{s:"QNX",r:/QNX/},{s:"UNIX",r:/UNIX/},{s:"BeOS",r:/BeOS/},{s:"OS/2",r:/OS\/2/},{s:"SearchBot",r:W}],d;for(d in e)if(j=e[d],j.r.test(f)){g=j.s;break}d="unknown";/Windows/.test(g)&&
"Windows Phone"!=g&&(d=/Windows (.*)/.exec(g)[1],g="Windows");switch(g){case "Mac OSX":d=/Mac OS X (10[\.\_\d]+)/.exec(f)[1];break;case "Windows Phone":d=(/Windows Phone ([\.\_\d]+)/.exec(f)||["","8.0"])[1];break;case "Android":d=/Android ([\.\_\d]+)/.exec(f)[1];break;case "iOS":d=/OS (\d+)_(\d+)_?(\d+)?/.exec(c),d=d[1]+"."+d[2]+"."+(d[3]|0)}A=a._os=g;a._os_version=d;c=navigator.language||navigator.browserLanguage||navigator.systemLanguage||navigator.userLanguage;"undefined"!==typeof c&&(a._locale=
c);if("undefined"!==typeof document.referrer&&document.referrer.length&&(c=X.exec(document.referrer))&&c[11]&&c[11]!=window.location.hostname){c=!1;if(y&&y.length)for(g=0;g<y.length;g++)try{if(RegExp(y[g]).test(document.referrer)){m("Ignored:",document.referrer);c=!0;break}}catch(k){}c||(a._store=document.referrer)}m("Got metrics",a);return a}function m(){b.debug&&"undefined"!==typeof console&&(arguments[1]&&"object"==typeof arguments[1]&&(arguments[1]=JSON.stringify(arguments[1])),console.log(Array.prototype.slice.call(arguments).join("\n")))}
function l(){return Math.floor((new Date).getTime()/1E3)}function Q(a,c,b){var b=b||Y,e="";"object"===typeof a?"undefined"!==typeof a.stack?e=a.stack:("undefined"!==typeof a.name&&(e+=a.name+":"),"undefined"!==typeof a.message&&(e+=a.message+"\n"),"undefined"!==typeof a.fileName&&(e+="in "+a.fileName+"\n"),"undefined"!==typeof a.lineNumber&&(e+="on "+a.lineNumber),"undefined"!==typeof a.columnNumber&&(e+=":"+a.columnNumber)):e=a+"";var c=c?!0:!1,a=D(),e={_os:a._os,_os_version:a._os_version,_resolution:a._resolution,
_error:e,_app_version:a._app_version,_run:l()-Z,_not_os_specific:!0},j=navigator.battery||navigator.webkitBattery||navigator.mozBattery||navigator.msBattery;j&&(e._bat=Math.floor(100*j.level));"undefined"!==typeof navigator.onLine&&(e._online=navigator.onLine?!0:!1);e._background=document.hasFocus()?!1:!0;0<H.length&&(e._logs=H.join("\n"));H=[];e._nonfatal=c;e._view=(window.location.pathname||"")+(window.location.search||"")+(window.location.hash||"");e._browser=a._browser;"undefined"!==typeof b&&
(e._custom=b);try{var h=document.createElement("canvas").getContext("experimental-webgl");e._opengl=h.getParameter(h.VERSION)}catch(i){}r({crash:JSON.stringify(e)})}function $(a,c){for(var b={},e,j=0;j<c.length;j++)e=c[j],"undefined"!==typeof a[e]&&(b[e]=a[e]);return b}function aa(a){"undefined"==typeof a.pageY&&("number"==typeof a.clientX&&document.documentElement)&&(a.pageX=a.clientX+document.body.scrollLeft+document.documentElement.scrollLeft,a.pageY=a.clientY+document.body.scrollTop+document.documentElement.scrollTop);
return a}var da="javascript_native_web",ba=!1,x=!1,V="/i",P=500,K=1E3,s=[],t=[],H=[],z={},y=[],Y=null,T=!0,w,ca=0,C=null,E=0,R=0,U=0,O=60,I=20,J=0,M=60,G=10,N=!0,A,X=/^(((([^:\/#\?]+:)?(?:(\/\/)((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/,W=/(nuhk|Googlebot|Yammybot|Openbot|Slurp|MSNBot|Ask Jeeves\/Teoma|ia_archiver|bingbot|Google Web Preview|Mediapartners-Google|AdsBot-Google|Baiduspider|Ezooms|YahooSeeker|AltaVista|AVSearch|Mercator|Scooter|InfoSeek|Ultraseek|Lycos|Wget|YandexBot|Yandex|YaDirectFetcher|SiteBot|Exabot|AhrefsBot|MJ12bot|TurnitinBot|magpie-crawler|Nutch Crawler|CMS Crawler|rogerbot|Domnutch|ssearch_bot|XoviBot|netseer|digincore|fr-crawler|wesee|AliasIO)/,
F=!1,B=!0,Z;b.init=function(a){if(!ba){Z=l();ba=!0;s=q("cly_queue")||[];z={};t=q("cly_event")||[];a=a||{};P=a.interval||b.interval||P;K=a.queue_size||b.queue_size||K;O=a.fail_timeout||b.fail_timeout||O;I=a.inactivity_time||b.inactivity_time||I;M=a.session_update||b.session_update||M;G=a.max_events||b.max_events||G;b.ignore_prefetch=a.ignore_prefetch||b.ignore_prefetch||!0;b.debug=a.debug||b.debug||!1;b.app_key=a.app_key||b.app_key||null;var c=b,f;if(!(f=a.device_id))if(!(f=b.device_id))if(!(f=q("cly_id"))){var e=
(new Date).getTime();f="xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var c=(e+16*Math.random())%16|0;e=Math.floor(e/16);return("x"==a?c:c&3|8).toString(16)})}c.device_id=f;c=b;f=a.url||b.url||"https://cloud.count.ly";f="/"==f.substr(f.length-1)?f.substr(0,f.length-1):f;c.url=f;b.app_version=a.app_version||b.app_version||"0.0";b.country_code=a.country_code||b.country_code||null;b.city=a.city||b.city||null;b.ip_address=a.ip_address||b.ip_address||null;b.ignore_bots=a.ignore_bots||
...
pull:function(a,b){v(a,b,"$pull")},save:function(){r({user_details:JSON.stringify({custom:u})});u={}}};b.track_errors=function(a){Y=a;window.onerror=function(a,b,e,j,h){if("undefined"!==typeof h)Q(h,!1);else{var j=j||window.event&&window.event.errorCharacter,i="";"undefined"!==typeof a&&(i+=a+"\n");"undefined"!==typeof b&&(i+="at "+b);"undefined"!==typeof e&&(i+=":"+e);"undefined"!==typeof j&&(i+=":"+j);i+="\n";try{for(var g=[],d=arguments.callee.caller;d;)g.push(d.name),d=d.caller;i+=g.join("\n")}catch(m){}Q(i,
...
f=a?"undefined"!==typeof a.target?a.target:a.srcElement:window.event.srcElement;aa(a);b.add_event({key:"linkClick",segmentation:{href:f.href,text:f.innerText,id:f.id,x:a.pageX,y:a.pageY}});"undefined"!==typeof f.href&&"_blank"!==f.target&&!a.metaKey&&!a.altKey&&!a.ctrlKey&&!a.shiftKey&&0!==f.href.replace(window.location.href.split("#")[0],"").indexOf("#")&&b.end_session()}if("undefined"!==typeof a.getElementsByTagName)for(var e=a.getElementsByTagName("a"),j=0;j<e.length;j++)k(e[j],"click",c);else m("Can't track clicks")}
a=a||document;"complete"===document.readyState?c():k(window,"load",c)};b.track_forms=function(a){function c(a){return a.name||a.id||a.type||a.nodeName}function f(a){var f=!1;k(a,"submit",function(){if(!f){f=!0;var e={id:a.id,name:a.name,action:a.action,method:a.method},g;if("undefined"!==typeof a.elements)for(var d=0;d<a.elements.length;d++)if((g=a.elements[d])&&"password"!=g.type)if("undefined"===typeof e["input:"+c(g)]&&(e["input:"+c(g)]=[]),"select"==g.nodeName.toLowerCase())if("undefined"!==typeof g.multiple){var m=
[];if("undefined"!==typeof g.options)for(var n=0;n<g.options.length;n++)g.options[n].selected&&m.push(g.options[n].value);e["input:"+c(g)].push(m.join(", "))}else e["input:"+c(g)].push(g.options[g.selectedIndex].value);else"input"==g.nodeName.toLowerCase()?"undefined"!==typeof g.type?"checkbox"==g.type.toLowerCase()||"radio"==g.type.toLowerCase()?g.checked&&e["input:"+c(g)].push(g.value):e["input:"+c(g)].push(g.value):e["input:"+c(g)].push(g.value):"textarea"==g.nodeName.toLowerCase()?e["input:"+
c(g)].push(g.value):"undefined"!==typeof g.value&&e["input:"+c(g)].push(g.value);for(var k in e)"undefined"!=typeof e[k].join&&(e[k]=e[k].join(", "));b.add_event({key:"formSubmit",segmentation:e});b.end_session()}})}function e(){if("undefined"!==typeof a.getElementsByTagName)for(var b=a.getElementsByTagName("form"),c=0;c<b.length;c++)f(b[c]);else m("Can't track forms")}a=a||document;"complete"===document.readyState?e():k(window,"load",e)};b.collect_from_forms=function(a,c){function f(e){var f=!1;
k(e,"submit",function(){if(!f){f=!0;var i={},g=!1,d;if("undefined"!==typeof e.elements){var k={},n=a.getElementsByTagName("LABEL"),l;for(l=0;l<n.length;l++)n[l].htmlFor&&""!==n[l].htmlFor&&(k[n[l].htmlFor]=n[l].innerText||n[l].textContent||n[l].innerHTML);for(l=0;l<e.elements.length;l++)if((d=e.elements[l])&&"password"!=d.type&&-1==d.className.indexOf("cly_user_ignore")){var p="";if("select"==d.nodeName.toLowerCase())if("undefined"!==typeof d.multiple){p=[];if("undefined"!==typeof d.options)for(n=
...
d[n].indexOf("cly_user_")){i[d[n].replace("cly_user_","")]=p;g=!0;break}}else if(d.type&&"email"==d.type.toLowerCase()||d.name&&-1!=d.name.toLowerCase().indexOf("email")||d.id&&-1!=d.id.toLowerCase().indexOf("email")||d.id&&k[d.id]&&-1!=k[d.id].toLowerCase().indexOf("email")||/[^@\s]+@[^@\s]+\.[^@\s]+/.test(p))i.email||(i.email=p),g=!0;else if(d.name&&-1!=d.name.toLowerCase().indexOf("username")||d.id&&-1!=d.id.toLowerCase().indexOf("username")||d.id&&k[d.id]&&-1!=k[d.id].toLowerCase().indexOf("username"))i.username||
(i.username=p),g=!0;else if(d.name&&(-1!=d.name.toLowerCase().indexOf("tel")||-1!=d.name.toLowerCase().indexOf("phone")||-1!=d.name.toLowerCase().indexOf("number"))||d.id&&(-1!=d.id.toLowerCase().indexOf("tel")||-1!=d.id.toLowerCase().indexOf("phone")||-1!=d.id.toLowerCase().indexOf("number"))||d.id&&k[d.id]&&(-1!=k[d.id].toLowerCase().indexOf("tel")||-1!=k[d.id].toLowerCase().indexOf("phone")||-1!=k[d.id].toLowerCase().indexOf("number")))i.phone||(i.phone=p),g=!0;else if(d.name&&(-1!=d.name.toLowerCase().indexOf("org")||
-1!=d.name.toLowerCase().indexOf("company"))||d.id&&(-1!=d.id.toLowerCase().indexOf("org")||-1!=d.id.toLowerCase().indexOf("company"))||d.id&&k[d.id]&&(-1!=k[d.id].toLowerCase().indexOf("org")||-1!=k[d.id].toLowerCase().indexOf("company")))i.organization||(i.organization=p),g=!0;else if(d.name&&-1!=d.name.toLowerCase().indexOf("name")||d.id&&-1!=d.id.toLowerCase().indexOf("name")||d.id&&k[d.id]&&-1!=k[d.id].toLowerCase().indexOf("name"))i.name||(i.name=""),i.name+=p+" ",g=!0}}g&&(m("Gathered user data",
i),c?b.user_details({custom:i}):b.user_details(i));b.end_session()}})}function e(){if("undefined"!==typeof a.getElementsByTagName)for(var b=a.getElementsByTagName("form"),c=0;c<b.length;c++)f(b[c]);else m("Can't track forms")}a=a||document;"complete"===document.readyState?e():k(window,"load",e)};b.collect_from_facebook=function(a){FB&&FB.api&&FB.api("/me",function(c){var f={};c.name&&(f.name=c.name);c.email&&(f.email=c.email);"male"==c.gender?f.gender="M":"female"==c.gender&&(f.gender="F");if(c.birthday){var e=
c.birthday.split("/").pop();e&&4==e.length&&(f.byear=e)}c.work&&(c.work[0]&&c.work[0].employer&&c.work[0].employer.name)&&(f.organization=c.work[0].employer.name);if(a){f.custom={};for(var j in a){for(var e=a[j].split("."),h=c,i=0;i<e.length&&!(h=h[e[i]],"undefined"===typeof h);i++);"undefined"!==typeof h&&(f.custom[j]=h)}}b.user_details(f)})};var k=function(a,b,f){"undefined"!==typeof a.addEventListener?a.addEventListener(b,f,!1):a.attachEvent("on"+b,f)},q=function(a,b,f){function e(a,b,c){var e=
new Date;e.setTime(e.getTime()+864E5*c);c="; expires="+e.toGMTString();document.cookie=a+"="+b+c+"; path=/"}var f=f||!1,j=!1,h;if("undefined"!==typeof localStorage){j=!0;try{localStorage.setItem("testLocal",!0)}catch(i){j=!1}}"undefined"!==typeof b&&null!==b&&("object"===typeof b&&(b=JSON.stringify(b)),j?localStorage.setItem(a,b):f||e(a,b,30));if("undefined"===typeof b){if(j)h=localStorage.getItem(a);else if(!f)a:{a+="=";b=document.cookie.split(";");f=0;for(j=b.length;f<j;f++){for(h=b[f];" "===h.charAt(0);)h=
h.substring(1,h.length);if(0===h.indexOf(a)){h=h.substring(a.length,h.length);break a}}h=null}try{h=JSON.parse(h)}catch(g){}return h}null===b&&(j?localStorage.removeItem(a):f||e(a,"",-1))}})(window.Countly=window.Countly||{});
