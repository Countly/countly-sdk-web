...
"Internet Explorer";else if(-1!=e.indexOf("IEMobile"))c="IE Mobile";else if(-1!=e.indexOf("Chrome"))c="Chrome";else if(-1!=e.indexOf("Safari"))c="Safari";else if(-1!=e.indexOf("Firefox"))c="Firefox";else if(-1!=e.indexOf("Trident/"))c="Internet Explorer";else if(-1!=e.indexOf("FBAN/"))c="Facebook app";else if(-1!=e.indexOf("baiduboxapp/"))c="Baidu Box App";else if((g=e.lastIndexOf(" ")+1)<(m=e.lastIndexOf("/")))c=e.substring(g,m),c.toLowerCase()==c.toUpperCase()&&(c=navigator.appName);a._browser=
c;c="unknown";g=[{s:"Windows 3.11",r:/Win16/},{s:"Windows 95",r:/(Windows 95|Win95|Windows_95)/},{s:"Windows ME",r:/(Win 9x 4.90|Windows ME)/},{s:"Windows 98",r:/(Windows 98|Win98)/},{s:"Windows CE",r:/Windows CE/},{s:"Windows 2000",r:/(Windows NT 5.0|Windows 2000)/},{s:"Windows XP",r:/(Windows NT 5.1|Windows XP)/},{s:"Windows Server 2003",r:/Windows NT 5.2/},{s:"Windows Vista",r:/Windows NT 6.0/},{s:"Windows 7",r:/(Windows 7|Windows NT 6.1)/},{s:"Windows 8.1",r:/(Windows 8.1|Windows NT 6.3)/},{s:"Windows 8",
r:/(Windows 8|Windows NT 6.2)/},{s:"Windows NT 4.0",r:/(Windows NT 4.0|WinNT4.0|WinNT|Windows NT)/},{s:"Windows ME",r:/Windows ME/},{s:"Windows Phone",r:/Windows Phone/},{s:"Android",r:/Android/},{s:"Open BSD",r:/OpenBSD/},{s:"Sun OS",r:/SunOS/},{s:"Linux",r:/(Linux|X11)/},{s:"iOS",r:/(iPhone|iPad|iPod)/},{s:"Mac OSX",r:/Mac OS X/},{s:"Mac OS",r:/(MacPPC|MacIntel|Mac_PowerPC|Macintosh)/},{s:"QNX",r:/QNX/},{s:"UNIX",r:/UNIX/},{s:"BeOS",r:/BeOS/},{s:"OS/2",r:/OS\/2/},{s:"SearchBot",r:M}];for(var i in g)if(m=
g[i],m.r.test(e)){c=m.s;break}i="unknown";/Windows/.test(c)&&"Windows Phone"!=c&&(i=/Windows (.*)/.exec(c)[1],c="Windows");switch(c){case "Mac OSX":i=/Mac OS X (10[\.\_\d]+)/.exec(e)[1];break;case "Windows Phone":i=(/Windows Phone ([\.\_\d]+)/.exec(e)||["","8.0"])[1];break;case "Android":i=/Android ([\.\_\d]+)/.exec(e)[1];break;case "iOS":i=/OS (\d+)_(\d+)_?(\d+)?/.exec(d),i=i[1]+"."+i[2]+"."+(i[3]|0)}w=a._os=c;a._os_version=i;d=navigator.language||navigator.browserLanguage||navigator.systemLanguage||
navigator.userLanguage;"undefined"!==typeof d&&(a._locale=d);if("undefined"!==typeof document.referrer&&document.referrer.length&&(d=N.exec(document.referrer))&&d[11]&&d[11]!=window.location.hostname)a._store=document.referrer;f("Got metrics",a);return a}function f(){b.debug&&"undefined"!==typeof console&&(arguments[1]&&"object"==typeof arguments[1]&&(arguments[1]=JSON.stringify(arguments[1])),console.log(Array.prototype.slice.call(arguments).join("\n")))}function j(){return Math.floor((new Date).getTime()/
1E3)}function G(a,d,b){var b=b||O,c="";"object"===typeof a?"undefined"!==typeof a.stack?c=a.stack:("undefined"!==typeof a.name&&(c+=a.name+":"),"undefined"!==typeof a.message&&(c+=a.message+"\n"),"undefined"!==typeof a.fileName&&(c+="in "+a.fileName+"\n"),"undefined"!==typeof a.lineNumber&&(c+="on "+a.lineNumber),"undefined"!==typeof a.columnNumber&&(c+=":"+a.columnNumber)):c=a+"";var d=d?!0:!1,a=y(),c={_os:a._os,_os_version:a._os_version,_resolution:a._resolution,_error:c,_app_version:a._app_version,
_run:j()-P,_not_os_specific:!0},g=navigator.battery||navigator.webkitBattery||navigator.mozBattery||navigator.msBattery;g&&(c._bat=Math.floor(100*g.level));"undefined"!==typeof navigator.onLine&&(c._online=navigator.onLine?!0:!1);c._background=document.hasFocus()?!1:!0;0<A.length&&(c._logs=A.join("\n"));A=[];c._nonfatal=d;c._view=(window.location.pathname||"")+(window.location.search||"")+(window.location.hash||"");c._browser=a._browser;"undefined"!==typeof b&&(c._custom=b);try{var m=document.createElement("canvas").getContext("experimental-webgl");
