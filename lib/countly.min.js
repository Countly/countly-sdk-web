(function(n,ka){"function"===typeof define&&define.amd?define([],function(){return ka(n.Countly)}):"object"===typeof module&&module.exports?module.exports=ka(n.Countly):n.Countly=ka(n.Countly)})("undefined"!==typeof window?window:this,function(n){function ka(h){var p=[];if("undefined"!==typeof h.options)for(var u=0;u<h.options.length;u++)h.options[u].selected&&p.push(h.options[u].value);return p.join(", ")}function ab(){var h=(new Date).getTime();return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,
function(p){var u=(h+16*Math.random())%16|0;h=Math.floor(h/16);return("x"===p?u:u&3|8).toString(16)})}function B(){return Math.floor((new Date).getTime()/1E3)}function Ra(){var h=(new Date).getTime();Ba>=h?Ba++:Ba=h;return Ba}function r(h,p,u){if(p&&Object.keys(p).length){if("undefined"!==typeof p[h])return p[h]}else if("undefined"!==typeof n[h])return n[h];return u}function Sa(h,p,u){for(var C in n.i)n.i[C].tracking_crashes&&n.i[C].recordError(h,p,u)}function bb(h){var p=[],u;for(u in h)p.push(u+
"="+encodeURIComponent(h[u]));return p.join("&")}function la(h){return"string"===typeof h&&"/"===h.substring(h.length-1)?h.substring(0,h.length-1):h}function oa(h,p){for(var u={},C,K=0,O=p.length;K<O;K++)C=p[K],"undefined"!==typeof h[C]&&(u[C]=h[C]);return u}function T(h,p,u,C,K,O){var Y={};if(h){if(Object.keys(h).length>C){var Z={},pa=0,ba;for(ba in h)pa<C&&(Z[ba]=h[ba],pa++);h=Z}for(var F in h)C=w(F,p,K,O),Z=w(h[F],u,K,O),Y[C]=Z}return Y}function w(h,p,u,C){var K=h;"number"===typeof h&&(h=h.toString());
"string"===typeof h&&h.length>p&&(K=h.substring(0,p),C(d.DEBUG,u+", Key: [ "+h+" ] is longer than accepted length. It will be truncated."));return K}function qa(h){if(h)return h;h=navigator.userAgent;!h&&navigator.userAgentData&&(h=navigator.userAgentData.brands.map(function(p){return p.brand+":"+p.version}).join(),h+=navigator.userAgentData.mobile?" mobi ":" ",h+=navigator.userAgentData.platform);return h}function cb(h){if(!h){if(navigator.userAgentData.mobile)return"phone";h=qa()}h=h.toLowerCase();
...
"add_cly_event",c);a.segmentation=T(a.segmentation,g.maxKeyLength,g.maxValueSize,g.maxSegmentationValues,"add_cly_event",c);var b=oa(a,["key","count","sum","dur","segmentation"]);b.timestamp=Ra();var e=new Date;b.hour=e.getHours();b.dow=e.getDay();G.push(b);v("cly_event",G);c(d.INFO,"Successfully adding event: ",a)}else c(d.ERROR,"Adding event failed. Event must have a key property")}function u(a,b,e,k,l){c(d.INFO,"fetch_remote_config_explicit, Fetching sequence initiated");var f={method:"rc"};Array.isArray(arguments[0])&&
0<arguments[0].length&&(f.keys=JSON.stringify(arguments[0]));Array.isArray(arguments[1])&&0<arguments[1].length&&(f.omit_keys=JSON.stringify(arguments[1]));for(var m=arguments.length-1,q;m--;)"legacy"===arguments[m]&&(f.method="fetch_remote_config"),0===arguments[m]&&(f.oi=0),1===arguments[m]&&(f.oi=1),"function"===typeof arguments[m]&&(q=arguments[m]);g.check_consent("sessions")&&(f.metrics=JSON.stringify(Ea()));g.check_consent("remote-config")?(ba(f),aa("fetch_remote_config_explicit",g.url+Fa,f,
function(t,I,U){if(t)c(d.ERROR,"fetch_remote_config_explicit, An error occurred: "+t);else{try{var J=JSON.parse(U);if(f.keys||f.omit_keys)for(var ca in J)M[ca]=J[ca];else M=J;v("cly_remote_configs",M)}catch(ra){c(d.ERROR,"fetch_remote_config_explicit, Had an issue while parsing the response: "+ra)}q&&(c(d.INFO,"fetch_remote_config_explicit, Callback function is provided"),q(t,M))}},!0)):(c(d.ERROR,"fetch_remote_config_explicit, Remote config requires explicit consent"),q&&q(Error("Remote config requires explicit consent"),
M))}function C(){g.ignore_prefetch&&"undefined"!==typeof document.visibilityState&&"prerender"===document.visibilityState&&(g.ignore_visitor=!0);g.ignore_bots&&db()&&(g.ignore_visitor=!0)}function K(){0<G.length&&(F({events:JSON.stringify(G)}),G=[],v("cly_event",G))}function O(a,b){if(document.getElementById("countly-feedback-sticker-"+a._id))c(d.ERROR,"Widget with same ID exists");else try{var e=document.createElement("div");e.className="countly-iframe-wrapper";e.id="countly-iframe-wrapper-"+a._id;
var k=document.createElement("span");k.className="countly-feedback-close-icon";k.id="countly-feedback-close-icon-"+a._id;k.innerText="x";var l=document.createElement("iframe");l.name="countly-feedback-iframe";l.id="countly-feedback-iframe";l.src=g.url+"/feedback?widget_id="+a._id+"&app_key="+g.app_key+"&device_id="+g.device_id+"&sdk_version=22.06.3";document.body.appendChild(e);e.appendChild(k);e.appendChild(l);x(document.getElementById("countly-feedback-close-icon-"+a._id),"click",function(){document.getElementById("countly-iframe-wrapper-"+
a._id).style.display="none";document.getElementById("cfbg").style.display="none"});if(b){var f=document.createElementNS("http://www.w3.org/2000/svg","svg");f.id="feedback-sticker-svg";f.setAttribute("aria-hidden","true");f.setAttribute("data-prefix","far");f.setAttribute("data-icon","grin");f.setAttribute("class","svg-inline--fa fa-grin fa-w-16");f.setAttribute("role","img");f.setAttribute("xmlns","http://www.w3.org/2000/svg");f.setAttribute("viewBox","0 0 496 512");var m=document.createElementNS("http://www.w3.org/2000/svg",
...
"/"+a,g.namespace&&(a=la(g.namespace)+"/"+a)),void 0===e&&(e=ha),"undefined"!==typeof b&&null!==b&&(b=g.serialize(b),e?localStorage.setItem(a,b):"localstorage"!==g.storage&&pb(a,b,30)))}function R(a,b,e){"none"===g.storage?c(d.WARNING,"Storage is disabled. Value with key: "+a+" won't be removed"):(e||(a=g.app_key+"/"+a,g.namespace&&(a=la(g.namespace)+"/"+a)),void 0===b&&(b=ha),b?localStorage.removeItem(a):"localstorage"!==g.storage&&pb(a,"",-1))}function sb(){if(y(g.namespace+"cly_id",!1,!0)){v("cly_id",
...
y(g.namespace+"cly_ignore",!1,!0));R("cly_id",!1,!0);R("cly_id_type",!1,!0);R("cly_event",!1,!0);R("cly_session",!1,!0);R("cly_queue",!1,!0);R("cly_cmp_id",!1,!0);R("cly_cmp_uid",!1,!0);R("cly_ignore",!1,!0)}}var g=this,Ja=!n.i,V=!1,kb="/i",Fa="/o/sdk",Na=r("interval",h,500),Ga=r("queue_size",h,1E3),E=[],G=[],M={},ia=[],ja={},Q=r("ignore_referrers",h,[]),Ya=null,ua=!0,fa,Za=0,P=null,sa=0,ta=0,Va=0,Ma=r("fail_timeout",h,60),za=r("inactivity_time",h,20),Aa=0,Ka=r("session_update",h,60),wa=r("max_events",
h,100),ma=r("max_logs",h,null),ea=r("use_session_cookie",h,!0),va=r("session_cookie_timeout",h,30),La=!0,Ia=!1,H=r("offline_mode",h,!1),W={},da=!0,qb=B(),ha=!0,na=null,D=1,ya=!1,xa=0;try{localStorage.setItem("cly_testLocal",!0),localStorage.removeItem("cly_testLocal")}catch(a){c(d.ERROR,"Local storage test failed, Halting local storage support: "+a),ha=!1}for(var A={},$a=0;$a<n.features.length;$a++)A[n.features[$a]]={};this.initialize=function(){this.serialize=r("serialize",h,n.serialize);this.deserialize=
...
l,h&&Object.keys(h).length?void 0!==h.device_id&&(D=0):void 0!==n.device_id&&(D=0)):H||b?(this.device_id="[CLY]_temp_id",D=2,H&&b?c(d.INFO,"initialize, Temp ID set, continuing offline mode from previous app session"):H&&!b?c(d.INFO,"initialize, Temp ID set, entering offline mode"):(H=!0,c(d.INFO,"initialize, Temp ID set, enabling offline mode"))):(c(d.INFO,"initialize, Generating the device ID"),this.device_id=r("device_id",h,Wa()),h&&Object.keys(h).length?void 0!==h.device_id&&(D=0):void 0!==n.device_id&&
(D=0));v("cly_id",this.device_id);v("cly_id_type",D);if(e){for(var m in this.utm)k[m]?this.userData.set("utm_"+m,k[m]):this.userData.unset("utm_"+m);this.userData.save()}Y();setTimeout(function(){Ha();g.remote_config&&g.fetch_remote_config(g.remote_config)},1);document.documentElement.setAttribute("data-countly-useragent",qa())}};this.halt=function(){c(d.WARNING,"halt, Resetting Countly");n.i=void 0;Ja=!n.i;V=!1;kb="/i";Fa="/o/sdk";Na=500;Ga=1E3;E=[];G=[];M={};ia=[];ja={};Q=[];Ya=null;ua=!0;Za=0;
P=null;Va=ta=sa=0;Ma=60;za=20;Aa=0;Ka=60;wa=100;ma=null;ea=!0;va=30;La=!0;H=Ia=!1;W={};da=!0;qb=B();ha=!0;na=null;D=1;ya=!1;xa=0;try{localStorage.setItem("cly_testLocal",!0),localStorage.removeItem("cly_testLocal")}catch(b){c(d.ERROR,"halt, Local storage test failed, will fallback to cookies"),ha=!1}n.features="sessions events views scrolls clicks forms crashes attribution users star-rating location apm feedback remote-config".split(" ");A={};for(var a=0;a<n.features.length;a++)A[n.features[a]]={};
...
function(z){"complete"===z.target.readyState&&x(document,"mouseleave",function(){L||(L=!0,k(a))})});break;case "onScrollHalfwayDown":x(window,"scroll",function(){if(!L){var z=Math.max(window.scrollY,document.body.scrollTop,document.documentElement.scrollTop),N=Ca();z>=N/2&&(L=!0,k(a))}});break;default:L||(L=!0,k(a))}}else if("nps"===a.type)document.getElementById("countly-"+q+"-wrapper-"+a._id).style.display="block",document.getElementById("csbg").style.display="block";else if("rating"===a.type){var Qa=
!1;"complete"===document.readyState?Qa||(Qa=!0,l(a)):x(document,"readystatechange",function(z){"complete"!==z.target.readyState||Qa||(Qa=!0,l(a))})}}catch(z){c(d.ERROR,"present_feedback_widget, Something went wrong while presenting the widget: "+z)}};this.recordError=function(a,b,e){c(d.INFO,"recordError, Recording error");if(this.check_consent("crashes")&&a){e=e||Ya;var k="";"object"===typeof a?"undefined"!==typeof a.stack?k=a.stack:("undefined"!==typeof a.name&&(k+=a.name+":"),"undefined"!==typeof a.message&&
