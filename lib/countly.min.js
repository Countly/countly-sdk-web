...
(c+=a.name+":"),"undefined"!==typeof a.message&&(c+=a.message+"\n"),"undefined"!==typeof a.fileName&&(c+="in "+a.fileName+"\n"),"undefined"!==typeof a.lineNumber&&(c+="on "+a.lineNumber),"undefined"!==typeof a.columnNumber&&(c+=":"+a.columnNumber)):c=a+"";var e=e?!0:!1,a=y(),c={_os:a._os,_os_version:a._os_version,_resolution:a._resolution,_error:c,_app_version:a._app_version,_run:j()-O,_not_os_specific:!0},g=navigator.battery||navigator.webkitBattery||navigator.mozBattery||navigator.msBattery;g&&
(c._bat=Math.floor(100*g.level));"undefined"!==typeof navigator.onLine&&(c._online=navigator.onLine?!0:!1);c._background=document.hasFocus()?!1:!0;0<A.length&&(c._logs=A.join("\n"));A=[];c._nonfatal=e;c._custom="undefined"!==typeof b?b:{};c._custom.Page=(window.location.pathname||"")+(window.location.search||"")+(window.location.hash||"");c._custom.Browser=a._browser;try{var m=document.createElement("canvas").getContext("experimental-webgl");c._opengl=m.getParameter(m.VERSION)}catch(i){}n({crash:JSON.stringify(c)})}
function V(a){var e=[],b;for(b in a)e.push(b+"="+encodeURIComponent(a[b]));return e.join("&")}function P(a,e){for(var b={},c,g=0;g<e.length;g++)c=e[g],"undefined"!==typeof a[c]&&(b[c]=a[c]);return b}function Q(a){"undefined"==typeof a.pageY&&("number"==typeof a.clientX&&document.documentElement)&&(a.pageX=a.clientX+document.body.scrollLeft+document.documentElement.scrollLeft,a.pageY=a.clientY+document.body.scrollTop+document.documentElement.scrollTop);return a}var R=!1,u=!1,U="/i",E=500,r=[],v=[],
A=[],s={},N=null,J=!0,t,S=0,x=null,z=0,G=0,K=0,D=60,w,M=/^(((([^:\/#\?]+:)?(?:(\/\/)((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/,L=/(nuhk|Googlebot|Yammybot|Openbot|Slurp|MSNBot|Ask Jeeves\/Teoma|ia_archiver|bingbot|Google Web Preview|Mediapartners-Google|Baiduspider|Ezooms|YahooSeeker|AltaVista|AVSearch|Mercator|Scooter|InfoSeek|Ultraseek|Lycos|Wget|YandexBot|SiteBot|Exabot|AhrefsBot|MJ12bot|TurnitinBot|magpie-crawler|Nutch Crawler|CMS Crawler|rogerbot|Domnutch|ssearch_bot|XoviBot|netseer|digincore|fr-crawler)/,
