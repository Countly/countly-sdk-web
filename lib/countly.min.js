...
A),"function"===typeof k&&k(!0,c)}}function bb(a,b){if(!(200<=a&&300>a))return d(g.ERROR,"Http response status code is not within the expected range: "+a),!1;try{var c=JSON.parse(b);return"[object Object]"!==Object.prototype.toString.call(c)?(d(g.ERROR,"Http response is not JSON Object"),!1):!0}catch(k){return d(g.ERROR,"Http response is not JSON: "+k),!1}}function ab(a,b){if(!(200<=a&&300>a))return d(g.ERROR,"Http response status code is not within the expected range: "+a),!1;try{var c=JSON.parse(b);
...
F.substring(1,F.length);if(0===F.indexOf(r))return F.substring(r.length,F.length)}return null}if("none"===f.storage)d(g.WARNING,"Storage is disabled. Value with key: "+a+" won't be stored or retrieved");else{k||(a=f.app_key+"/"+a,f.namespace&&(a=Ca(f.namespace)+"/"+a));c=c||"localstorage"===f.storage;"undefined"!==typeof b&&null!==b&&(b=f.serialize(b),aa?localStorage.setItem(a,b):c||l(a,b,30));if("undefined"===typeof b){if(aa){console.info("Checking local storage for the key: "+a);var m=localStorage.getItem(a)}else c||
(console.info("Checking cookies for the key: "+a),m=e(a));return f.deserialize(m)}null===b&&(aa?localStorage.removeItem(a):c||l(a,"",-1))}}function hb(){if(p(f.namespace+"cly_id",void 0,!1,!0)){p("cly_id",p(f.namespace+"cly_id",void 0,!1,!0));p("cly_event",p(f.namespace+"cly_event",void 0,!1,!0));p("cly_session",p(f.namespace+"cly_session",void 0,!1,!0));var a=p(f.namespace+"cly_queue",void 0,!1,!0);Array.isArray(a)&&(a=a.filter(function(b){return b.app_key===f.app_key}),p("cly_queue",a));p(f.namespace+
"cly_cmp_id",void 0,!1,!0)&&(p("cly_cmp_id",p(f.namespace+"cly_cmp_id",void 0,!1,!0)),p("cly_cmp_uid",p(f.namespace+"cly_cmp_uid",void 0,!1,!0)));p(f.namespace+"cly_ignore",void 0,!1,!0)&&p("cly_ignore",p(f.namespace+"cly_ignore",void 0,!1,!0));p("cly_id",null,!1,!0);p("cly_event",null,!1,!0);p("cly_session",null,!1,!0);p("cly_queue",null,!1,!0);p("cly_cmp_id",null,!1,!0);p("cly_cmp_uid",null,!1,!0);p("cly_ignore",null,!1,!0)}}var f=this,sa=!n.i,R=!1,Ya="/i",Ia="/o/sdk",$a=v("interval",h,500),Wa=
v("queue_size",h,1E3),D=[],G=[],J={},ba=[],ca={},W=v("ignore_referrers",h,[]),Ja=null,ma=!0,Z,Ka=0,X=null,ja=0,ka=0,Ha=0,Za=v("fail_timeout",h,60),La=v("inactivity_time",h,20),na=0,Xa=v("session_update",h,60),Ga=v("max_events",h,100),va=v("max_logs",h,null),la=v("use_session_cookie",h,!0),Fa=v("session_cookie_timeout",h,30),ta=!0,ra=!1,S=v("offline_mode",h,!1),T={},Y=!0,db=C(),aa=!0,ha=null;try{localStorage.setItem("cly_testLocal",!0),localStorage.removeItem("cly_testLocal")}catch(a){d(g.ERROR,"Local storage test failed, Halting local storage support: "+
a),aa=!1}for(var B={},Ma=0;Ma<n.features.length;Ma++)B[n.features[Ma]]={};this.initialize=function(){this.serialize=h.serialize||n.serialize;this.deserialize=h.deserialize||n.deserialize;this.getViewName=h.getViewName||n.getViewName;this.getViewUrl=h.getViewUrl||n.getViewUrl;this.namespace=v("namespace",h,"");this.app_key=v("app_key",h,null);this.onload=v("onload",h,[]);this.utm=v("utm",h,{source:!0,medium:!0,campaign:!0,term:!0,content:!0});this.ignore_prefetch=v("ignore_prefetch",h,!0);this.debug=
v("debug",h,!1);this.test_mode=v("test_mode",h,!1);this.tests=v("tests",h,!1);this.metrics=v("metrics",h,{});this.headers=v("headers",h,{});this.url=Ca(v("url",h,""));this.app_version=v("app_version",h,"0.0");this.country_code=v("country_code",h,null);this.city=v("city",h,null);this.ip_address=v("ip_address",h,null);this.ignore_bots=v("ignore_bots",h,!0);this.force_post=v("force_post",h,!1);this.remote_config=v("remote_config",h,!1);this.ignore_visitor=v("ignore_visitor",h,!1);this.require_consent=
...
h,200);va&&!this.maxBreadcrumbCount?(this.maxBreadcrumbCount=va,d(g.WARNING,"initialize, 'maxCrashLogs' is deprecated. Use 'maxBreadcrumbCount' instead!")):va||this.maxBreadcrumbCount||(this.maxBreadcrumbCount=100);"cookie"===this.storage&&(aa=!1);Array.isArray(W)||(W=[]);""===this.url&&(d(g.ERROR,"initialize, Please provide server URL"),this.ignore_visitor=!0);p("cly_ignore")&&(this.ignore_visitor=!0);hb();S?this.device_id||(this.device_id="[CLY]_temp_id"):this.device_id=v("device_id",h,ea());D=
p("cly_queue")||[];G=p("cly_event")||[];J=p("cly_remote_configs")||{};t();if(window.name&&0===window.name.indexOf("cly:"))try{this.passed_data=JSON.parse(window.name.replace("cly:",""))}catch(m){d(g.ERROR,"initialize, Could not parse name: "+window.name+", error: "+m)}else if(location.hash&&0===location.hash.indexOf("#cly:"))try{this.passed_data=JSON.parse(location.hash.replace("#cly:",""))}catch(m){d(g.ERROR,"initialize, Could not parse hash: "+location.hash+", error: "+m)}(this.passed_data&&this.passed_data.app_key&&
this.passed_data.app_key===this.app_key||this.passed_data&&!this.passed_data.app_key&&sa)&&this.passed_data.token&&this.passed_data.purpose&&(this.passed_data.token!==p("cly_old_token")&&(cb(this.passed_data.token),p("cly_old_token",this.passed_data.token)),this.passed_data.url=this.passed_data.url||this.url,"heatmap"===this.passed_data.purpose&&(this.ignore_visitor=!0,Ta(),Sa(this.passed_data.url+"/views/heatmap.js",Ua)));if(!this.ignore_visitor){d(g.INFO,"initialize, Countly initialized");if(location.search){for(var a=
location.search.substring(1).split("&"),b={},c=!1,k=0;k<a.length;k++){var l=a[k].split("=");"cly_id"===l[0]?p("cly_cmp_id",l[1]):"cly_uid"===l[0]?p("cly_cmp_uid",l[1]):"cly_device_id"===l[0]?this.device_id=l[1]:0===(l[0]+"").indexOf("utm_")&&this.utm[l[0].replace("utm_","")]&&(b[l[0].replace("utm_","")]=l[1],c=!0)}if(c){for(var e in this.utm)b[e]?this.userData.set("utm_"+e,b[e]):this.userData.unset("utm_"+e);this.userData.save()}}S||this.device_id!==p("cly_id")&&p("cly_id",this.device_id);H();setTimeout(function(){V();
f.remote_config&&f.fetch_remote_config(f.remote_config)},1)}document.documentElement.setAttribute("data-countly-useragent",navigator.userAgent)};this.halt=function(){d(g.WARNING,"halt, Resetting Countly");n.i=void 0;sa=!n.i;R=!1;Ya="/i";Ia="/o/sdk";$a=500;Wa=1E3;D=[];G=[];J={};ba=[];ca={};W=[];Ja=null;ma=!0;Ka=0;X=null;Ha=ka=ja=0;Za=60;La=20;na=0;Xa=60;Ga=100;va=null;la=!0;Fa=30;ta=!0;S=ra=!1;T={};Y=!0;db=C();aa=!0;ha=null;try{localStorage.setItem("cly_testLocal",!0),localStorage.removeItem("cly_testLocal")}catch(b){aa=
