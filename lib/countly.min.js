...
l.documentElement.clientHeight))}function lb(){var l=document;return Math.max(Math.max(l.body.scrollWidth,l.documentElement.scrollWidth),Math.max(l.body.offsetWidth,l.documentElement.offsetWidth),Math.max(l.body.clientWidth,l.documentElement.clientWidth))}function Eb(){var l=document;return Math.min(Math.min(l.body.clientHeight,l.documentElement.clientHeight),Math.min(l.body.offsetHeight,l.documentElement.offsetHeight),window.innerHeight)}function Fb(l,k,q,v,G,Q){l=document.createElement(l);var O;
l.setAttribute(k,q);l.setAttribute(v,G);k=function(){O||Q();O=!0};Q&&(l.onreadystatechange=k,l.onload=k);document.getElementsByTagName("head")[0].appendChild(l)}function Gb(l,k){Fb("script","type","text/javascript","src",l,k)}function Sa(l,k){Fb("link","rel","stylesheet","href",l,k)}function Hb(){if(x){var l=document.getElementById("cly-loader");if(!l){var k=document.head||document.getElementsByTagName("head")[0],q=document.createElement("style");q.type="text/css";q.styleSheet?q.styleSheet.cssText=
...
Pa=0,Tb=function(l,k,q){k&&zb(l.prototype,k);q&&zb(l,q);Object.defineProperty(l,"prototype",{writable:!1});return l}(function q(k){function v(a,d){if(f.ignore_visitor)b(c.ERROR,"Adding event failed. Possible bot or user opt out");else if(a.key){a.count||(a.count=1);Xb.includes(a.key)||(a.key=z(a.key,f.maxKeyLength,"add_cly_event",b));a.segmentation=aa(a.segmentation,f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,"add_cly_event",b);a=za(a,["key","count","sum","dur","segmentation"]);a.timestamp=
...
b(c.WARNING,"User is opt_out will ignore the request: "+a):f.app_key&&f.device_id?(Ea(a),H.length>Va&&H.shift(),H.push(a),w("cly_queue",H,!0)):b(c.ERROR,"app_key or device_id is missing ",f.app_key,f.device_id)}function Wa(){Aa();if(f.ignore_visitor)Xa=!1,b(c.WARNING,"User opt_out, no heartbeat");else{Xa=!0;Ya&&"undefined"!==typeof p.q&&0<p.q.length&&mb();if(W&&Ia&&pa){var a=F();a-ja>Za&&(f.session_duration(a-ja),ja=a,0<f.hcErrorCount&&w(T.errorCount,f.hcErrorCount),0<f.hcWarningCount&&w(T.warningCount,
f.hcWarningCount))}0<J.length&&!f.test_mode_eq&&(J.length<=Ka?(N({events:JSON.stringify(J)}),J=[]):(a=J.splice(0,Ka),N({events:JSON.stringify(a)})),w("cly_event",J));!K&&0<H.length&&$a&&F()>nb&&($a=!1,a=H[0],a.rr=H.length,b(c.DEBUG,"Processing request",a),w("cly_queue",H,!0),f.test_mode||ba("send_request_queue",f.url+ob,a,function(d,e){d?nb=F()+ab:H.shift();w("cly_queue",H,!0);$a=!0},!1));setTimeout(Wa,bb)}}function mb(){var a=p.q;p.q=[];for(var d=0;d<a.length;d++){var e=a[d];b(c.DEBUG,"Processing queued calls:"+
...
return a?(D=y("cly_id_type"),a):gb()}function Lb(){return f.metrics._ua||ua()}function Ta(){var a=JSON.parse(JSON.stringify(f.metrics||{}));a._app_version=a._app_version||f.app_version;a._ua=a._ua||ua();if(x&&screen.width){var d=screen.width?parseInt(screen.width):0,e=screen.height?parseInt(screen.height):0;if(0!==d&&0!==e){if(navigator.platform&&/iPad|iPhone|iPod/.test(navigator.platform)&&window.devicePixelRatio)d=Math.round(d*window.devicePixelRatio),e=Math.round(e*window.devicePixelRatio);else if(90===
...
La=Math.max(La,window.scrollY,document.body.scrollTop,document.documentElement.scrollTop):b(c.WARNING,"processScroll, window object is not available. Not processing scroll.")}function tb(){if(!x)b(c.WARNING,"processScrollView, window object is not available. Not processing scroll view.");else if(Ma){Ma=!1;var a=Ra(),d=lb(),e=Eb();f.check_consent("scrolls")&&(a={type:"scroll",y:La+e,width:d,height:a,view:f.getViewUrl()},a=aa(a,f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,"processScrollView",
b),f.track_domains&&(a.domain=window.location.hostname),v({key:M.ACTION,segmentation:a}))}}function Pb(a){w("cly_token",a)}function Qb(a,d,e){var h=new Date;h.setTime(h.getTime()+864E5*e);e="; expires="+h.toGMTString();document.cookie=a+"="+d+e+"; path=/"}function y(a,d,e){if("none"===f.storage||"object"!==L(f.storage)&&!x)b(c.DEBUG,"Storage is disabled. Value with key: ["+a+"] won't be retrieved");else{e||(a=f.app_key+"/"+a,f.namespace&&(a=ta(f.namespace)+"/"+a));if("object"===L(f.storage)&&"function"===
typeof f.storage.getItem){var h=f.storage.getItem(a);return a.endsWith("cly_id")?h:f.deserialize(h)}void 0===d&&(d=ra);if(d)h=localStorage.getItem(a);else if("localstorage"!==f.storage)a:{d=a+"=";e=document.cookie.split(";");h=0;for(var m=e.length;h<m;h++){for(var g=e[h];" "===g.charAt(0);)g=g.substring(1,g.length);if(0===g.indexOf(d)){h=g.substring(d.length,g.length);break a}}h=null}return a.endsWith("cly_id")?h:f.deserialize(h)}}function w(a,d,e,h){"none"===f.storage||"object"!==L(f.storage)&&!x?
b(c.DEBUG,"Storage is disabled. Value with key: "+a+" won't be stored"):(h||(a=f.app_key+"/"+a,f.namespace&&(a=ta(f.namespace)+"/"+a)),"undefined"!==typeof d&&null!==d&&("object"===L(f.storage)&&"function"===typeof f.storage.setItem?f.storage.setItem(a,d):(void 0===e&&(e=ra),d=f.serialize(d),e?localStorage.setItem(a,d):"localstorage"!==f.storage&&Qb(a,d,30))))}function S(a,d,e){"none"===f.storage||"object"!==L(f.storage)&&!x?b(c.DEBUG,"Storage is disabled. Value with key: "+a+" won't be removed"):
(e||(a=f.app_key+"/"+a,f.namespace&&(a=ta(f.namespace)+"/"+a)),"object"===L(f.storage)&&"function"===typeof f.storage.removeItem?f.storage.removeItem(a):(void 0===d&&(d=ra),d?localStorage.removeItem(a):"localstorage"!==f.storage&&Qb(a,"",-1)))}function Yb(){if(y(f.namespace+"cly_id",!1,!0)){w("cly_id",y(f.namespace+"cly_id",!1,!0));w("cly_id_type",y(f.namespace+"cly_id_type",!1,!0));w("cly_event",y(f.namespace+"cly_event",!1,!0));w("cly_session",y(f.namespace+"cly_session",!1,!0));var a=y(f.namespace+
...
!0)}}if(!(this instanceof q))throw new TypeError("Cannot call a class as a function");var f=this,Ya=!p.i,W=!1,ob="/i",Ua="/o/sdk",bb=t("interval",k,500),Va=t("queue_size",k,1E3),H=[],J=[],R={},sa=[],da={},ca=t("ignore_referrers",k,[]),ub=null,Ia=!0,ja,vb=0,X=null,Ga=0,Ha=0,nb=0,ab=t("fail_timeout",k,60),Na=t("inactivity_time",k,20),Oa=0,Za=t("session_update",k,60),Ka=t("max_events",k,100),wa=t("max_logs",k,null),ia=t("use_session_cookie",k,!0),Ja=t("session_cookie_timeout",k,30),$a=!0,Xa=!1,K=t("offline_mode",
k,!1),ea={},pa=!0,Rb=F(),ra=!0,xa=null,D=1,Ma=!1,La=0,wb=!1,ha=null,Da=null,ka=null,va=t("sdk_name",k,"javascript_native_web"),oa=t("sdk_version",k,"23.12.5");try{localStorage.setItem("cly_testLocal",!0),localStorage.removeItem("cly_testLocal")}catch(a){b(c.ERROR,"Local storage test failed, Halting local storage support: "+a),ra=!1}for(var E={},xb=0;xb<p.features.length;xb++)E[p.features[xb]]={};this.initialize=function(){this.serialize=t("serialize",k,p.serialize);this.deserialize=t("deserialize",
...
va&&"23.12.5"===oa?b(c.DEBUG,"initialize, SDK name:["+va+"], version:["+oa+"]"):b(c.DEBUG,"initialize, SDK name:["+va+"], version:["+oa+"], default name:[javascript_native_web] and default version:[23.12.5]");b(c.DEBUG,"initialize, app_key:["+this.app_key+"], url:["+this.url+"]");b(c.DEBUG,"initialize, device_id:["+t("device_id",k,void 0)+"]");b(c.DEBUG,"initialize, require_consent is enabled:["+this.require_consent+"]");try{b(c.DEBUG,"initialize, metric override:["+JSON.stringify(this.metrics)+"]"),
...
(this.userData.set("utm_"+n,e[n]),ka[n]=e[n]):this.userData.unset("utm_"+n);this.userData.save()}Aa();setTimeout(function(){p.noHeartBeat?b(c.WARNING,"initialize, Heartbeat disabled. This is for testing purposes only!"):Wa();f.remote_config&&f.fetch_remote_config(f.remote_config)},1);x&&document.documentElement.setAttribute("data-countly-useragent",ua());qa.sendInstantHCRequest()}};this.halt=function(){b(c.WARNING,"halt, Resetting Countly");p.i=void 0;p.q=[];p.noHeartBeat=void 0;Ya=!p.i;W=!1;ob="/i";
Ua="/o/sdk";bb=500;Va=1E3;H=[];J=[];R={};sa=[];da={};ca=[];ub=null;Ia=!0;vb=0;X=null;nb=Ha=Ga=0;ab=60;Na=20;Oa=0;Za=60;Ka=100;wa=null;ia=!0;Ja=30;$a=!0;K=Xa=!1;ea={};pa=!0;Rb=F();ra=!0;xa=null;D=1;Ma=!1;La=0;wb=!1;ka=Da=ha=null;try{localStorage.setItem("cly_testLocal",!0),localStorage.removeItem("cly_testLocal")}catch(d){b(c.ERROR,"halt, Local storage test failed, will fallback to cookies"),ra=!1}p.features="sessions events views scrolls clicks forms crashes attribution users star-rating location apm feedback remote-config".split(" ");
...
pa&&(pa=!1,vb=F()-ja,Ha=F()-Ga)};this.start_time=function(){b(c.INFO,"start_time, Starting tracking duration");pa||(pa=!0,ja=F()-vb,Ga=F()-Ha,Ha=0,Ba())};this.track_sessions=function(){function a(){document[e]||!document.hasFocus()?f.stop_time():f.start_time()}function d(){Oa>=Na&&f.start_time();Oa=0}if(x){b(c.INFO,"track_session, Starting tracking user session");this.begin_session();this.start_time();A(window,"beforeunload",function(){O();f.end_session()});var e="hidden";A(window,"focus",a);A(window,
...
d);A(window,"keydown",d);A(window,"scroll",d);setInterval(function(){Oa++;Oa>=Na&&f.stop_time()},6E4)}else b(c.WARNING,"track_sessions, window object is not available. Not tracking sessions.")};this.track_pageview=function(a,d,e){if(x||a)if(b(c.INFO,"track_pageview, Tracking page views"),b(c.VERBOSE,"track_pageview, last view is:["+X+"], current view ID is:["+ha+"], previous view ID is:["+Da+"]"),X&&wb&&(b(c.DEBUG,"track_pageview, Scroll registry triggered"),tb(),Ma=!0,La=0),ma(),Da=ha,ha=fb(),(a=
...
(m=Kb.exec(document.referrer))&&m[11]&&m[11]!==window.location.hostname&&(h.start=1);if(ka&&Object.keys(ka).length){b(c.INFO,"track_pageview, Adding fresh utm tags to segmentation:["+JSON.stringify(ka)+"]");for(var g in ka)"undefined"===typeof h["utm_"+g]&&(h["utm_"+g]=ka[g])}x&&qb()&&(b(c.INFO,"track_pageview, Adding referrer to segmentation:["+document.referrer+"]"),h.referrer=document.referrer);if(e){e=aa(e,f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,"track_pageview",b);for(var n in e)"undefined"===
...
this.track_scrolls=function(a){x?(b(c.INFO,"track_scrolls, Starting to track scrolls"),a&&b(c.INFO,"track_scrolls, Tracking the specified children"),a=a||window,wb=Ma=!0,A(a,"scroll",Ob),A(a,"beforeunload",tb)):b(c.WARNING,"track_scrolls, window object is not available. Not tracking scrolls.")};this.track_links=function(a){x?(b(c.INFO,"track_links, Starting to track clicks to links"),a&&b(c.INFO,"track_links, Tracking the specified children"),a=a||document,A(a,"click",function(d){a:{var e=Qa(d);var h;
...
case "cly_event":J=f.deserialize(d||"[]");break;case "cly_remote_configs":R=f.deserialize(d||"{}");break;case "cly_ignore":f.ignore_visitor=f.deserialize(d);break;case "cly_id":f.device_id=d;break;case "cly_id_type":D=f.deserialize(d)}};this._internals={store:w,getDocWidth:lb,getDocHeight:Ra,getViewportHeight:Eb,get_page_coord:kb,get_event_target:Qa,add_event_listener:A,createNewObjectFromProperties:za,truncateObject:aa,truncateSingleValue:z,stripTrailingSlash:ta,prepareParams:ya,sendXmlHttpRequest:Mb,
isResponseValid:sb,getInternalDeviceIdType:function(){return D},getMsTimestamp:hb,getTimestamp:F,isResponseValidBroad:rb,secureRandom:fb,log:b,checkIfLoggingIsOn:Ca,getMetrics:Ta,getUA:Lb,prepareRequest:Ea,generateUUID:gb,sendEventsForced:O,isUUID:function(a){return/[0-9a-fA-F]{8}\-[0-9a-fA-F]{4}\-4[0-9a-fA-F]{3}\-[0-9a-fA-F]{4}\-[0-9a-fA-F]{12}/.test(a)},isReferrerUsable:qb,getId:pb,heartBeat:Wa,toRequestQueue:N,reportViewDuration:ma,loadJS:Gb,loadCSS:Sa,getLastView:function(){return X},setToken:Pb,
getToken:function(){var a=y("cly_token");S("cly_token");return a},showLoader:Hb,hideLoader:Ib,setValueInStorage:w,getValueFromStorage:y,removeValueFromStorage:S,add_cly_events:v,processScrollView:tb,processScroll:Ob,currentUserAgentString:ua,currentUserAgentDataString:jb,userAgentDeviceDetection:Cb,userAgentSearchBotDetection:Db,getRequestQueue:function(){return H},getEventQueue:function(){return J},sendFetchRequest:Nb,processAsyncQueue:mb,makeNetworkRequest:ba,clearQueue:function(){H=[];w("cly_queue",
[]);J=[];w("cly_event",[])},getLocalQueues:function(){return{eventQ:J,requestQ:H}}};var qa={sendInstantHCRequest:function(){var a=z(f.hcErrorMessage,1E3,"healthCheck",b);a={el:f.hcErrorCount,wl:f.hcWarningCount,sc:f.hcStatusCode,em:JSON.stringify(a)};a={hc:JSON.stringify(a),metrics:JSON.stringify({_app_version:f.app_version})};Ea(a);ba("[healthCheck]",f.url+ob,a,function(d){d||qa.resetAndSaveCounters()},!0)},resetAndSaveCounters:function(){qa.resetCounters();w(T.errorCount,f.hcErrorCount);w(T.warningCount,
...
p.q=p.q||[];p.onload=p.onload||[];p.CountlyClass=Tb;p.init=function(k){k=k||{};if(p.loadAPMScriptsAsync&&Ub)Ub=!1,Wb(k);else{var q=k.app_key||p.app_key;if(!p.i||!p.i[q]){k=new Tb(k);if(!p.i){p.i={};for(var v in k)p[v]=k[v]}p.i[q]=k}return p.i[q]}};p.serialize=function(k){"object"===L(k)&&(k=JSON.stringify(k));return k};p.deserialize=function(k){if(""===k)return k;try{k=JSON.parse(k)}catch(q){Ca()&&console.warn("[WARNING] [Countly] deserialize, Could not parse the file:["+k+"], error: "+q)}return k};
