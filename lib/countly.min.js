...
a.appendChild(b);a=document.createElement("div");a.setAttribute("id","cly-loader");document.body.appendChild(a)}a.style.display="block"}function ka(){var a=document.getElementById("cly-loader");a&&(a.style.display="none")}var ra="17.04",qa="javascript_native_web",la=!1,v=!1,ea="/i",Q=500,K=1E3,p=[],q=[],E=[],u={},w=[],ba=null,M=!0,t,ma=0,x=null,z=0,W=0,X=0,P=60,F=20,G=0,N=60,B=10,C=0,O=!0,pa,L=!1,aa=/^(((([^:\/#\?]+:)?(?:(\/\/)((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/,
...
(a.dur=m()-u[a.key],b.add_event(a),delete u[a.key]):i("Timed event with key "+a.key+" was not started"):i("Event must have key property")};b.user_details=function(a){i("Adding userdetails: ",a);n({user_details:JSON.stringify(S(a,"name username email organization phone picture gender byear custom".split(" ")))})};b.report_conversion=function(a,b){a=a||h("cly_cmp_id")||"cly_organic";b=b||h("cly_cmp_uid");a&&b?n({campaign_id:a,campaign_user:b}):a?n({campaign_id:a}):i("No campaign data found")};var r=
{},s=function(a,b,e){r[a]||(r[a]={});"$push"==e||"$pull"==e||"$addToSet"==e?(r[a][e]||(r[a][e]=[]),r[a][e].push(b)):r[a][e]=b};b.userData={set:function(a,b){r[a]=b},set_once:function(a){s(a,1,"$setOnce")},increment:function(a){s(a,1,"$inc")},increment_by:function(a,b){s(a,b,"$inc")},multiply:function(a,b){s(a,b,"$mul")},max:function(a,b){s(a,b,"$max")},min:function(a,b){s(a,b,"$min")},push:function(a,b){s(a,b,"$push")},push_unique:function(a,b){s(a,b,"$addToSet")},pull:function(a,b){s(a,b,"$pull")},
save:function(){n({user_details:JSON.stringify({custom:r})});r={}}};b.track_errors=function(a){ba=a;window.onerror=function(a,b,f,g,d){if("undefined"!==typeof d)D(d,!1);else{var g=g||window.event&&window.event.errorCharacter,k="";"undefined"!==typeof a&&(k+=a+"\n");"undefined"!==typeof b&&(k+="at "+b);"undefined"!==typeof f&&(k+=":"+f);"undefined"!==typeof g&&(k+=":"+g);k+="\n";try{for(var oa=[],i=arguments.callee.caller;i;)oa.push(i.name),i=i.caller;k+=oa.join("\n")}catch(h){}D(k,!1)}}};b.log_error=
function(a,b){D(a,!0,b)};b.add_log=function(a){E.push(a)};b.stop_time=function(){y&&(y=!1,ma=m()-t,W=m()-z)};b.start_time=function(){y||(y=!0,t=m()-ma,z=m()-W,W=0)};b.track_sessions=function(){function a(){document[e]?b.stop_time():b.start_time()}function c(){G>=F&&b.start_time();G=0}b.begin_session();b.start_time();j(window,"beforeunload",function(){b.end_session()});j(window,"unload",function(){b.end_session()});var e="hidden";e in document?document.addEventListener("visibilitychange",a):(e="mozHidden")in
document?document.addEventListener("mozvisibilitychange",a):(e="webkitHidden")in document?document.addEventListener("webkitvisibilitychange",a):(e="msHidden")in document?document.addEventListener("msvisibilitychange",a):"onfocusin"in document?(j(window,"focusin",function(){b.start_time()}),j(window,"focusout",function(){b.stop_time()})):(j(window,"focus",function(){b.start_time()}),j(window,"blur",function(){b.stop_time()}),j(window,"pageshow",function(){b.start_time()}),j(window,"pagehide",function(){b.stop_time()}));
j(window,"mousemove",c);j(window,"click",c);j(window,"keydown",c);j(window,"scroll",c);setInterval(function(){G++;G>=F&&b.stop_time()},6E4)};b.track_pageview=function(a,c){I();a&&a.constructor===Array&&(c=a,a=null);a=a||window.location.pathname;if(c&&c.length)for(var e=0;e<c.length;e++)try{if(RegExp(c[e]).test(a)){i("Ignored:",a);return}}catch(f){}x=a;z=m();e={name:a,visit:1,domain:window.location.hostname};if("undefined"!==typeof document.referrer&&document.referrer.length){var g=aa.exec(document.referrer);
...
!0},1E3)}})};b.track_scrolls=function(a){function c(a){if(e){e=!1;var c=U(),k=V(),i=ga();b.add_event({key:"[CLY]_action",segmentation:{type:"scroll",y:f+i,width:k,height:c,domain:window.location.hostname,view:window.location.pathname}});a&&(a.returnValue="");return""}}var a=a||window,e=!0,f=0;j(a,"scroll",function(){f=Math.max(f,window.scrollY,document.body.scrollTop,document.documentElement.scrollTop)});j(a,"beforeunload",c);j(a,"unload",c)};b.track_links=function(a){a=a||document;j(a,"click",function(a){var e=
H(a).closest("a");e&&(T(a),b.add_event({key:"linkClick",segmentation:{href:e.href,text:e.innerText,id:e.id,x:a.pageX,y:a.pageY,view:window.location.pathname}}),"undefined"!==typeof e.href&&"_blank"!==e.target&&!a.metaKey&&!a.altKey&&!a.ctrlKey&&!a.shiftKey&&0!==e.href.replace(window.location.href.split("#")[0],"").indexOf("#")&&b.end_session())})};b.track_forms=function(a){function c(a){return a.name||a.id||a.type||a.nodeName}a=a||document;j(a,"submit",function(a){var a=H(a),f={id:a.id,name:a.name,
action:a.action,method:a.method,view:window.location.pathname},g;if("undefined"!==typeof a.elements)for(var d=0;d<a.elements.length;d++)if((g=a.elements[d])&&"password"!=g.type)if("undefined"===typeof f["input:"+c(g)]&&(f["input:"+c(g)]=[]),"select"==g.nodeName.toLowerCase())if("undefined"!==typeof g.multiple){var k=[];if("undefined"!==typeof g.options)for(var i=0;i<g.options.length;i++)g.options[i].selected&&k.push(g.options[i].value);f["input:"+c(g)].push(k.join(", "))}else f["input:"+c(g)].push(g.options[g.selectedIndex].value);
else"input"==g.nodeName.toLowerCase()?"undefined"!==typeof g.type?"checkbox"==g.type.toLowerCase()||"radio"==g.type.toLowerCase()?g.checked&&f["input:"+c(g)].push(g.value):f["input:"+c(g)].push(g.value):f["input:"+c(g)].push(g.value):"textarea"==g.nodeName.toLowerCase()?f["input:"+c(g)].push(g.value):"undefined"!==typeof g.value&&f["input:"+c(g)].push(g.value);for(var h in f)"undefined"!=typeof f[h].join&&(f[h]=f[h].join(", "));b.add_event({key:"formSubmit",segmentation:f});b.end_session()})};b.collect_from_forms=
function(a,c){a=a||document;j(a,"submit",function(e){var e=H(e),f={},g=!1,d;if("undefined"!==typeof e.elements){var k={},h=a.getElementsByTagName("LABEL"),j;for(j=0;j<h.length;j++)h[j].htmlFor&&""!==h[j].htmlFor&&(k[h[j].htmlFor]=h[j].innerText||h[j].textContent||h[j].innerHTML);for(j=0;j<e.elements.length;j++)if((d=e.elements[j])&&"password"!=d.type&&-1==d.className.indexOf("cly_user_ignore")){var l="";if("select"==d.nodeName.toLowerCase())if("undefined"!==typeof d.multiple){l=[];if("undefined"!==
typeof d.options)for(h=0;h<d.options.length;h++)d.options[h].selected&&l.push(d.options[h].value);l=l.join(", ")}else l=d.options[d.selectedIndex].value;else"input"==d.nodeName.toLowerCase()?"undefined"!==typeof d.type?"checkbox"==d.type.toLowerCase()||"radio"==d.type.toLowerCase()?d.checked&&(l=d.value):l=d.value:l=d.value:"textarea"==d.nodeName.toLowerCase()?l=d.value:"undefined"!==typeof d.value&&(l=d.value);if(d.className&&-1!=d.className.indexOf("cly_user_")){d=d.className.split(" ");for(h=0;h<
d.length;h++)if(0===d[h].indexOf("cly_user_")){f[d[h].replace("cly_user_","")]=l;g=!0;break}}else if(d.type&&"email"==d.type.toLowerCase()||d.name&&-1!=d.name.toLowerCase().indexOf("email")||d.id&&-1!=d.id.toLowerCase().indexOf("email")||d.id&&k[d.id]&&-1!=k[d.id].toLowerCase().indexOf("email")||/[^@\s]+@[^@\s]+\.[^@\s]+/.test(l))f.email||(f.email=l),g=!0;else if(d.name&&-1!=d.name.toLowerCase().indexOf("username")||d.id&&-1!=d.id.toLowerCase().indexOf("username")||d.id&&k[d.id]&&-1!=k[d.id].toLowerCase().indexOf("username"))f.username||
(f.username=l),g=!0;else if(d.name&&(-1!=d.name.toLowerCase().indexOf("tel")||-1!=d.name.toLowerCase().indexOf("phone")||-1!=d.name.toLowerCase().indexOf("number"))||d.id&&(-1!=d.id.toLowerCase().indexOf("tel")||-1!=d.id.toLowerCase().indexOf("phone")||-1!=d.id.toLowerCase().indexOf("number"))||d.id&&k[d.id]&&(-1!=k[d.id].toLowerCase().indexOf("tel")||-1!=k[d.id].toLowerCase().indexOf("phone")||-1!=k[d.id].toLowerCase().indexOf("number")))f.phone||(f.phone=l),g=!0;else if(d.name&&(-1!=d.name.toLowerCase().indexOf("org")||
-1!=d.name.toLowerCase().indexOf("company"))||d.id&&(-1!=d.id.toLowerCase().indexOf("org")||-1!=d.id.toLowerCase().indexOf("company"))||d.id&&k[d.id]&&(-1!=k[d.id].toLowerCase().indexOf("org")||-1!=k[d.id].toLowerCase().indexOf("company")))f.organization||(f.organization=l),g=!0;else if(d.name&&-1!=d.name.toLowerCase().indexOf("name")||d.id&&-1!=d.id.toLowerCase().indexOf("name")||d.id&&k[d.id]&&-1!=k[d.id].toLowerCase().indexOf("name"))f.name||(f.name=""),f.name+=l+" ",g=!0}}g&&(i("Gathered user data",
...
d=c,h=0;h<f.length&&!(d=d[f[h]],"undefined"===typeof d);h++);"undefined"!==typeof d&&(e.custom[g]=d)}}b.user_details(e)})};b.opt_out=function(){b.ignore_visitor=!0;h("cly_ignore",!0)};b.opt_in=function(){h("cly_ignore",!1);b.ignore_visitor=!1;b.ignore_prefetch&&("undefined"!==typeof document.visibilityState&&"prerender"===document.visibilityState)&&(b.ignore_visitor=!0);b.ignore_bots&&na.test(navigator.userAgent)&&(b.ignore_visitor=!0);!b.ignore_visitor&&!L&&A()};Element.prototype.closest||(Element.prototype.closest=
...
(g?localStorage.removeItem(a):e||f(a,"",-1))};b._internals={store:h,getDocWidth:V,getDocHeight:U,getViewportHeight:ga,get_page_coord:T,get_event_target:H,add_event:j,getProperties:S,stripTrailingSlash:fa,prepareParams:da,sendXmlHttpRequest:Y,recordError:D,getMsTimestamp:J,getTimestamp:m,log:i,getMetrics:R,generateUUID:$,getId:Z,heartBeat:A,toRequestQueue:n,reportViewDuration:I,loadJS:ia,loadCSS:function(a,b){var e=document.createElement("link"),f;e.setAttribute("rel","stylesheet");e.setAttribute("href",
a);b&&(e.onreadystatechange=e.onload=function(){f||b();f=!0});document.getElementsByTagName("head")[0].appendChild(e)},getLastView:function(){return x},setToken:ha,getToken:function(){var a=h("cly_token");h("cly_token",null);return a},showLoader:ja,hideLoader:ka}})(window.Countly=window.Countly||{});
