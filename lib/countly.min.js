(function(b){function S(){if(A){var a={name:A,segment:da};b.add_event({key:"[CLY]_view",dur:n()-B,segmentation:a});A=null}}function q(a){if(!C)if(!b.app_key||!b.device_id)j("app_key or device_id is missing");else{a.app_key=b.app_key;a.device_id=b.device_id;a.sdk_name=ea;b.country_code&&(a.country_code=b.country_code);b.city&&(a.city=b.city);null!==b.ip_address&&(a.ip_address=b.ip_address);a.timestamp=T();var d=new Date;a.hour=d.getHours();a.dow=d.getDay();r.length>I&&r.shift();r.push(a);p("cly_queue",
r,!0)}}function J(){if("undefined"!==typeof b.q&&0<b.q.length){for(var a,d=0;d<b.q.length;d++)if(a=b.q[d],j("Processing queued call",a),"function"===typeof a)a();else if(a.constructor===Array&&0<a.length)if("undefined"!==typeof b[a[0]])b[a[0]].apply(null,a.slice(1));else{var e=a[0].replace("userData.","");"undefined"!==typeof b.userData[e]&&b.userData[e].apply(null,a.slice(1))}b.q=[]}x&&(K&&z)&&(a=n(),a-v>L&&(b.session_duration(a-v),v=a));0<s.length&&(s.length<=D?(q({events:JSON.stringify(s)}),s=
...
(arguments[1]&&"object"==typeof arguments[1]&&(arguments[1]=JSON.stringify(arguments[1])),console.log(Array.prototype.slice.call(arguments).join("\n")))}function n(){return Math.floor((new Date).getTime()/1E3)}function T(){var a=(new Date).getTime();E>=a?E++:E=a;return E}function P(a,d,e){var e=e||Y,b="";"object"===typeof a?"undefined"!==typeof a.stack?b=a.stack:("undefined"!==typeof a.name&&(b+=a.name+":"),"undefined"!==typeof a.message&&(b+=a.message+"\n"),"undefined"!==typeof a.fileName&&(b+="in "+
...
document.documentElement)&&(a.pageX=a.clientX+document.body.scrollLeft+document.documentElement.scrollLeft,a.pageY=a.clientY+document.body.scrollTop+document.documentElement.scrollTop);return a}var ea="javascript_native_web",ba=!1,x=!1,V="/i",O=500,I=1E3,r=[],s=[],F=[],w={},y=[],Y=null,K=!0,v,ca=0,A=null,B=0,Q=0,U=0,N=60,G=20,H=0,L=60,D=10,E=0,M=!0,da,X=/^(((([^:\/#\?]+:)?(?:(\/\/)((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/,
...
"cly_id"==e[0]?p("cly_cmp_id",e[1]):"cly_uid"==e[0]&&p("cly_cmp_uid",e[1])}}};b.begin_session=function(a){x||(j("Session started"),v=n(),x=!0,K=a?!1:!0,a={begin_session:1},a.metrics=JSON.stringify(W()),q(a))};b.session_duration=function(a){x&&(j("Session extended",a),q({session_duration:a}))};b.end_session=function(a){x&&(a=a||n()-v,j("Ending session"),S(),x=!1,q({end_session:1,session_duration:a}),J())};b.change_id=function(a,d){if(b.device_id!=a){d||(b.end_session(),w={});var e=b.device_id;b.device_id=
a;p("cly_id",b.device_id);j("Changing id");d?q({old_device_id:e}):b.begin_session(!K)}};b.add_event=function(a){if(a.key){a.count||(a.count=1);var d=$(a,["key","count","sum","dur","segmentation"]);d.timestamp=T();var b=new Date;d.hour=b.getHours();d.dow=b.getDay();s.push(d);p("cly_event",s);j("Adding event: ",a)}else j("Event must have key property")};b.start_event=function(a){w[a]?j("Timed event with key "+a+" already started"):w[a]=n()};b.end_event=function(a){"string"==typeof a&&(a={key:a});a.key?
w[a.key]?(a.dur=n()-w[a.key],b.add_event(a),delete w[a.key]):j("Timed event with key "+a.key+" was not started"):j("Event must have key property")};b.user_details=function(a){j("Adding userdetails: ",a);q({user_details:JSON.stringify($(a,"name username email organization phone picture gender byear custom".split(" ")))})};b.report_conversion=function(a,d){a=a||p("cly_cmp_id")||"cly_organic";d=d||p("cly_cmp_uid");a&&d?q({campaign_id:a,campaign_user:d}):a?q({campaign_id:a}):j("No campaign data found")};
var t={},u=function(a,d,b){t[a]||(t[a]={});"$push"==b||"$pull"==b||"$addToSet"==b?(t[a][b]||(t[a][b]=[]),t[a][b].push(d)):t[a][b]=d};b.userData={set:function(a,b){t[a]=b},set_once:function(a){u(a,1,"$setOnce")},increment:function(a){u(a,1,"$inc")},increment_by:function(a,b){u(a,b,"$inc")},multiply:function(a,b){u(a,b,"$mul")},max:function(a,b){u(a,b,"$max")},min:function(a,b){u(a,b,"$min")},push:function(a,b){u(a,b,"$push")},push_unique:function(a,b){u(a,b,"$addToSet")},pull:function(a,b){u(a,b,"$pull")},
save:function(){q({user_details:JSON.stringify({custom:t})});t={}}};b.track_errors=function(a){Y=a;window.onerror=function(a,b,g,f,c){if("undefined"!==typeof c)P(c,!1);else{var f=f||window.event&&window.event.errorCharacter,h="";"undefined"!==typeof a&&(h+=a+"\n");"undefined"!==typeof b&&(h+="at "+b);"undefined"!==typeof g&&(h+=":"+g);"undefined"!==typeof f&&(h+=":"+f);h+="\n";try{for(var i=[],k=arguments.callee.caller;k;)i.push(k.name),k=k.caller;h+=i.join("\n")}catch(j){}P(h,!1)}}};b.log_error=
function(a,b){P(a,!0,b)};b.add_log=function(a){F.push(a)};b.stop_time=function(){z&&(z=!1,ca=n()-v,Q=n()-B)};b.start_time=function(){z||(z=!0,v=n()-ca,B=n()-Q,Q=0)};b.track_sessions=function(){function a(){document[e]?b.stop_time():b.start_time()}function d(){H>=G&&b.start_time();H=0}b.begin_session();b.start_time();m(window,"beforeunload",function(){b.end_session()});m(window,"unload",function(){b.end_session()});var e="hidden";e in document?document.addEventListener("visibilitychange",a):(e="mozHidden")in
