(function(b){function S(){if(B){var a={name:B,segment:da};b.add_event({key:"[CLY]_view",dur:n()-C,segmentation:a});B=null}}function q(a){if(!z)if(!b.app_key||!b.device_id)j("app_key or device_id is missing");else{a.app_key=b.app_key;a.device_id=b.device_id;a.sdk_name=ea;b.country_code&&(a.country_code=b.country_code);b.city&&(a.city=b.city);null!==b.ip_address&&(a.ip_address=b.ip_address);a.timestamp=T();var d=new Date;a.hour=d.getHours();a.dow=d.getDay();r.length>I&&r.shift();r.push(a);p("cly_queue",
r,!0)}}function J(){if("undefined"!==typeof b.q&&0<b.q.length){for(var a,d=0;d<b.q.length;d++)if(a=b.q[d],j("Processing queued call",a),"function"===typeof a)a();else if(a.constructor===Array&&0<a.length)if("undefined"!==typeof b[a[0]])b[a[0]].apply(null,a.slice(1));else{var e=a[0].replace("userData.","");"undefined"!==typeof b.userData[e]&&b.userData[e].apply(null,a.slice(1))}b.q=[]}x&&(K&&A)&&(a=n(),a-v>L&&(b.session_duration(a-v),v=a));0<s.length&&(s.length<=D?(q({events:JSON.stringify(s)}),s=
...
document.documentElement)&&(a.pageX=a.clientX+document.body.scrollLeft+document.documentElement.scrollLeft,a.pageY=a.clientY+document.body.scrollTop+document.documentElement.scrollTop);return a}var ea="javascript_native_web",ba=!1,x=!1,V="/i",O=500,I=1E3,r=[],s=[],F=[],w={},y=[],Y=null,K=!0,v,ca=0,B=null,C=0,Q=0,U=0,N=60,G=20,H=0,L=60,D=10,E=0,M=!0,da,X=/^(((([^:\/#\?]+:)?(?:(\/\/)((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/,
