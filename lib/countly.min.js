...
(c._bat=Math.floor(100*g.level));"undefined"!==typeof navigator.onLine&&(c._online=navigator.onLine?!0:!1);c._background=document.hasFocus()?!1:!0;0<A.length&&(c._logs=A.join("\n"));A=[];c._nonfatal=e;c._view=(window.location.pathname||"")+(window.location.search||"")+(window.location.hash||"");c._browser=a._browser;"undefined"!==typeof b&&(c._custom=b);try{var m=document.createElement("canvas").getContext("experimental-webgl");c._opengl=m.getParameter(m.VERSION)}catch(i){}n({crash:JSON.stringify(c)})}
