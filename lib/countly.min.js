...
G=[];e._nonfatal=c;e._view=(window.location.pathname||"")+(window.location.search||"")+(window.location.hash||"");"undefined"!==typeof f&&(e._custom=f);try{var g=document.createElement("canvas").getContext("experimental-webgl");e._opengl=g.getParameter(g.VERSION)}catch(d){}q({crash:JSON.stringify(e)})}}function M(a,c,f){try{j("Sending XML HTTP request");var e=window.XMLHttpRequest?new window.XMLHttpRequest:window.ActiveXObject?new window.ActiveXObject("Microsoft.XMLHTTP"):null,c=c||{},g=wa(c),d="GET";
if(b.force_post||2E3<=g.length)d="POST";"GET"===d?e.open("GET",a+"?"+g,!0):(e.open("POST",a,!0),e.setRequestHeader("Content-type","application/x-www-form-urlencoded"));e.onreadystatechange=function(){4===this.readyState&&200<=this.status&&300>this.status?"function"===typeof f&&f(!1,c,this.responseText):4===this.readyState&&(j("Failed Server XML HTTP request",this.status),"function"===typeof f&&f(!0,c))};"GET"===d?e.send():e.send(g)}catch(h){j("Failed XML HTTP request",h),"function"===typeof f&&f(!0,
c)}}function wa(a){var c=[],b;for(b in a)c.push(b+"="+encodeURIComponent(a[b]));return c.join("&")}function xa(a){return"/"===a.substr(a.length-1)?a.substr(0,a.length-1):a}function T(a,c){for(var b={},e,g=0;g<c.length;g++)e=c[g],"undefined"!==typeof a[e]&&(b[e]=a[e]);return b}function ea(a){"undefined"==typeof a.pageY&&("number"==typeof a.clientX&&document.documentElement)&&(a.pageX=a.clientX+document.body.scrollLeft+document.documentElement.scrollLeft,a.pageY=a.clientY+document.body.scrollTop+document.documentElement.scrollTop);
...
a,!1);b.device_id=k("device_id",a,ra());b.url=xa(k("url",a,""));b.app_version=k("app_version",a,"0.0");b.country_code=k("country_code",a,null);b.city=k("city",a,null);b.ip_address=k("ip_address",a,null);b.ignore_bots=k("ignore_bots",a,!0);b.force_post=k("force_post",a,!1);b.q=b.q||[];b.onload=b.onload||[];b.ignore_visitor=k("ignore_visitor",a,!1);b.require_consent=k("require_consent",a,!1);a.ignore_referrers&&Array.isArray(a.ignore_referrers)?z=a.ignore_referrers:b.ignore_referrers&&Array.isArray(b.ignore_referrers)&&
(z=b.ignore_referrers);""===b.url&&(j("Please provide server URL"),b.ignore_visitor=!0);i("cly_ignore")&&(b.ignore_visitor=!0);ja();if(window.name&&0===window.name.indexOf("cly:"))try{b.passed_data=JSON.parse(window.name.replace("cly:",""))}catch(c){j("Could not parse name",window.name)}else if(location.hash&&0===location.hash.indexOf("#cly:"))try{b.passed_data=JSON.parse(location.hash.replace("#cly:",""))}catch(f){j("Could not parse hash",location.hash)}b.passed_data&&(b.passed_data.token&&b.passed_data.purpose)&&
(b.passed_data.token!==i("cly_old_token")&&(za(b.passed_data.token),i("cly_old_token",b.passed_data.token)),"heatmap"===b.passed_data.purpose&&(b.ignore_visitor=!0,Da(),Ba(b.url+"/views/heatmap.js",Ea)));if(!b.ignore_visitor){j("Countly initialized");b.onload.constructor!==Array&&(b.onload=[]);b.q.constructor!==Array&&(b.q=[]);K();i("cly_id",b.device_id);a=0;b.utm=b.utm||{source:!0,medium:!0,campaign:!0,term:!0,content:!0};if(location.search){for(var e=location.search.substring(1).split("&"),g={},
d=!1,a=0;a<e.length;a++){var h=e[a].split("=");"cly_id"===h[0]?i("cly_cmp_id",h[1]):"cly_uid"===h[0]?i("cly_cmp_uid",h[1]):0===(h[0]+"").indexOf("utm_")&&b.utm[h[0].replace("utm_","")]&&(g[h[0].replace("utm_","")]=h[1],d=!0)}if(d){for(var C in b.utm)g[C]?b.userData.set("utm_"+C,g[C]):b.userData.unset("utm_"+C);b.userData.save()}}la()}}};b.group_features=function(a){if(a)for(var c in a)m[c]?j("Feature name "+c+" is already reserved"):"string"===typeof a[c]?m[c]={features:[a[c]]}:a[c]&&Array.isArray(a[c])&&
a[c].length?m[c]={features:a[c]}:j("Incorrect feature list for "+c+" value: "+a[c]);else j("Incorrect features: "+a)};b.check_consent=function(a){if(!b.require_consent)return!0;if(m[a])return m[a]&&m[a].optin?!0:!1;j("No feature available for "+a);return!1};b.check_any_consent=function(){if(!b.require_consent)return!0;for(var a in m)if(m[a]&&m[a].optin)return!0;return!1};b.add_consent=function(a){j("Adding consent for "+a);if(Array.isArray(a))for(var c=0;c<a.length;c++)b.add_consent(a[c]);else m[a]?
m[a].features?(m[a].optin=!0,b.add_consent(m[a].features)):!0!==m[a].optin&&(w[a]=!0,m[a].optin=!0,Ha(),setTimeout(function(){"sessions"===a&&s.begin_session?(b.begin_session.apply(b,s.begin_session),s.begin_session=null):"views"===a&&s.track_pageview&&(D=null,b.track_pageview.apply(b,s.track_pageview),s.track_pageview=null);s.change_id&&(b.change_id.apply(b,s.change_id),s.change_id=null)},1)):j("No feature available for "+a)};b.remove_consent=function(a){j("Removing consent for "+a);if(Array.isArray(a))for(var c=
0;c<a.length;c++)b.remove_consent(a[c]);else m[a]?(m[a].features?b.remove_consent(m[a].features):!1!==m[a].optin&&(w[a]=!1,Ha()),m[a].optin=!1):j("No feature available for "+a)};var y,Ha=function(){y&&(clearTimeout(y),y=null);y=setTimeout(function(){qa(w)&&(q({consent:JSON.stringify(w)}),w={})},1E3)};b.begin_session=function(a,c){if(b.check_consent("sessions")){if(!F){x=n();F=!0;Z=a?!1:!0;var f=i("cly_session");if(c||!H||!f||parseInt(f)<=n())j("Session started"),f={begin_session:1},f.metrics=JSON.stringify(da()),
q(f);oa()}}else s.begin_session=arguments};b.session_duration=function(a){b.check_consent("sessions")&&F&&(j("Session extended",a),q({session_duration:a}),oa())};b.end_session=function(a,c){b.check_consent("sessions")&&F&&(a=a||n()-x,V(),!H||c?(j("Ending session"),q({end_session:1,session_duration:a})):b.session_duration(a),F=!1)};b.change_id=function(a,c){if(b.device_id!==a){c||(0<p.length&&(q({events:JSON.stringify(p)}),p=[],i("cly_event",p)),b.end_session(null,!0),A={});var f=b.device_id;b.device_id=
a;i("cly_id",b.device_id);j("Changing id");c?b.check_any_consent()?q({old_device_id:f}):s.change_id=arguments:b.begin_session(!Z,!0)}};b.add_event=function(a){b.check_consent("events")&&r(a)};b.start_event=function(a){A[a]?j("Timed event with key "+a+" already started"):A[a]=n()};b.end_event=function(a){"string"==typeof a&&(a={key:a});a.key?A[a.key]?(a.dur=n()-A[a.key],b.add_event(a),delete A[a.key]):j("Timed event with key "+a.key+" was not started"):j("Event must have key property")};b.user_details=
function(a){b.check_consent("users")&&(j("Adding userdetails: ",a),q({user_details:JSON.stringify(T(a,"name username email organization phone picture gender byear custom".split(" ")))}))};b.report_conversion=function(a,c){b.check_consent("attribution")&&(a=a||i("cly_cmp_id")||"cly_organic",c=c||i("cly_cmp_uid"),a&&c?q({campaign_id:a,campaign_user:c}):a&&q({campaign_id:a}))};var u={},v=function(a,c,f){b.check_consent("users")&&(u[a]||(u[a]={}),"$push"===f||"$pull"===f||"$addToSet"===f?(u[a][f]||(u[a][f]=
[]),u[a][f].push(c)):u[a][f]=c)};b.userData={set:function(a,c){u[a]=c},unset:function(a){u[a]=""},set_once:function(a,c){v(a,c,"$setOnce")},increment:function(a){v(a,1,"$inc")},increment_by:function(a,c){v(a,c,"$inc")},multiply:function(a,c){v(a,c,"$mul")},max:function(a,c){v(a,c,"$max")},min:function(a,c){v(a,c,"$min")},push:function(a,c){v(a,c,"$push")},push_unique:function(a,c){v(a,c,"$addToSet")},pull:function(a,c){v(a,c,"$pull")},save:function(){b.check_consent("users")&&q({user_details:JSON.stringify({custom:u})});
