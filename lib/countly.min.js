...
D(document.getElementById("countly-ratings-overlay-"+c._id),"click",function(){document.getElementById("countly-ratings-wrapper-"+c._id).style.display="none"})}J.appendChild(y);b(e,a).call(a,f.DEBUG,"present_feedback_widget, Appended the iframe");D(window,"message",function(E){b(e,a).call(a,f.DEBUG,"present_feedback_widget, Received message from widget with origin: ["+E.origin+"] and data: ["+E.data+"]");var V={};try{V=JSON.parse(E.data)}catch(Ic){b(e,a).call(a,f.ERROR,"present_feedback_widget, Error while parsing message body "+
Ic)}!0!==V.close?b(e,a).call(a,f.DEBUG,"present_feedback_widget, These are not the closing signals you are looking for"):(document.getElementById("countly-"+r+"-wrapper-"+c._id).style.display="none",document.getElementById("csbg").style.display="none",b(e,a).call(a,f.DEBUG,"present_feedback_widget, Closed the widget"))});var Ia=function(E){document.getElementById("countly-surveys-wrapper-"+E._id).style.display="block";document.getElementById("csbg").style.display="block"},Dc=function(E){for(var V=
...
r)}d={};d.crash=JSON.stringify(h);d.metrics=JSON.stringify({_ua:c._ua});b(Q,a).call(a,d)}});q(this,Pb,function(){b(e,a).call(a,f.INFO,"checkIgnore, Checking if user or visit should be ignored");a.ignore_prefetch&&A&&"undefined"!==typeof document.visibilityState&&"prerender"===document.visibilityState&&(a.ignore_visitor=!0,b(e,a).call(a,f.DEBUG,"checkIgnore, Ignoring visit due to prerendering"));a.ignore_bots&&ec()&&(a.ignore_visitor=!0,b(e,a).call(a,f.DEBUG,"checkIgnore, Ignoring visit due to bot"))});
w(this,"content",{enterContentZone:function(){b(Qb,a).call(a)},exitContentZone:function(){b(Ea,a)?(b(e,a).call(a,f.INFO,"content.exitContentZone, Exiting content zone"),l(Ea,a,!1),b(Va,a)&&(clearInterval(b(Va,a)),b(e,a).call(a,f.DEBUG,"content.exitContentZone, content zone exited"))):b(e,a).call(a,f.DEBUG,"content.exitContentZone, Not in content zone")}});q(this,Qb,function(c){A?b(Ea,a)&&!c?b(e,a).call(a,f.DEBUG,"content.enterContentZone, Already in content zone"):(b(e,a).call(a,f.INFO,"content.enterContentZone, Entering content zone"),
l(Ea,a,!0),c||b(Rb,a).call(a),l(Va,a,setInterval(function(){b(Rb,a).call(a)},b(qb,a)))):b(e,a).call(a,f.WARNING,"content.enterContentZone, window object is not available. Not entering content zone.")});q(this,oc,function(){b(e,a).call(a,f.DEBUG,"prepareContentRequest, forming content request");var c=b(kb,a).call(a,!0),d={l:{},p:{}},g=Math.max(c.width,c.height);c=Math.min(c.width,c.height);d.l.w=g;d.l.h=c;d.p.w=c;d.p.h=g;d={method:"queue",la:(navigator.language||navigator.browserLanguage||navigator.systemLanguage||
navigator.userLanguage).split("-")[0],resolution:JSON.stringify(d),cly_ws:1,cly_origin:window.location.origin};b(Ga,a).call(a,d);return d});q(this,Rb,function(){b(e,a).call(a,f.DEBUG,"sendContentRequest, sending content request");var c=b(oc,a).call(a);b(ea,a).call(a,"sendContentRequest,",a.url+b(Kb,a),c,function(d,g,h){if(!d){b(e,a).call(a,f.DEBUG,"sendContentRequest, received content: ["+h+"]");b(pc,a).call(a,h);clearInterval(b(Va,a));window.addEventListener("message",function(k){b(qc,a).call(a,
k)});var n;window.addEventListener("resize",function(){clearTimeout(n);n=setTimeout(function(){var k=window.innerWidth,r=window.innerHeight;document.getElementById(b(Xa,a)).contentWindow.postMessage({type:"resize",width:k,height:r},"*")},200)})}},!0)});q(this,pc,function(c){if(c){b(e,a).call(a,f.DEBUG,"displayContent, displaying content");c=JSON.parse(c);var d=document.createElement("iframe");d.id=b(Xa,a);d.src=c.html;d.style.position="absolute";var g=c.geo.p,h=b(kb,a).call(a,!0);h.width>=h.height&&
(g=c.geo.l);d.style.left=g.x+"px";d.style.top=g.y+"px";d.style.width=g.w+"px";d.style.height=g.h+"px";d.style.border="none";d.style.zIndex="999999";document.body.appendChild(d)}else b(e,a).call(a,f.DEBUG,"displayContent, no content to display")});q(this,qc,function(c){b(e,a).call(a,f.DEBUG,"sendContentRequest, Received message from: ["+c.origin+"] with data: ["+JSON.stringify(c.data)+"]");if(c.origin!==a.url)b(e,a).call(a,f.ERROR,"sendContentRequest, Received message from invalid origin");else{var d=
c.data;c=d.close;var g=d.link,h=d.event;d=d.resize_me;if(h){b(e,a).call(a,f.DEBUG,"sendContentRequest, Received event: ["+h+"]");1===c&&(b(e,a).call(a,f.DEBUG,"sendContentRequest, Closing content frame for event: ["+h+"]"),b(tb,a).call(a));if(!Array.isArray(h)){if("object"===R(h))throw new TypeError('"event" is read-only');b(e,a).call(a,f.ERROR,"sendContentRequest, Invalid event type: ["+R(h)+"]");return}for(var n=0;n<h.length;n++)b(Y,a).call(a,h[n])}g&&(1===c&&(b(e,a).call(a,f.DEBUG,"sendContentRequest, Closing content frame for link"),
b(tb,a).call(a)),window.open(g,"_blank"),b(e,a).call(a,f.DEBUG,"sendContentRequest, Opened link in new tab: [".concat(g,"]")));d&&(b(e,a).call(a,f.DEBUG,"sendContentRequest, Resizing iframe"),h=b(kb,a).call(a,!0),g=d.p,h.width>=h.height&&(g=d.l),d=document.getElementById(b(Xa,a)),d.style.left=g.x+"px",d.style.top=g.y+"px",d.style.width=g.w+"px",d.style.height=g.h+"px");1===c&&b(tb,a).call(a)}});q(this,tb,function(){var c=document.getElementById(b(Xa,a));c&&(c.remove(),b(e,a).call(a,f.DEBUG,"sendContentRequest, removed iframe"),
b(Ea,a)&&b(Qb,a).call(a,!0))});q(this,Fa,function(){0<b(N,a).length&&(b(e,a).call(a,f.DEBUG,"Flushing events"),b(Q,a).call(a,{events:JSON.stringify(b(N,a))}),l(N,a,[]),b(z,a).call(a,"cly_event",b(N,a)))});q(this,ub,function(c,d){if(A)if(document.getElementById("countly-feedback-sticker-"+c._id))b(e,a).call(a,f.ERROR,"Widget with same ID exists");else try{var g=document.createElement("div");g.className="countly-iframe-wrapper";g.id="countly-iframe-wrapper-"+c._id;var h=document.createElement("span");
