...
function xb(l,k){for(var q=0;q<k.length;q++){var v=k[q];v.enumerable=v.enumerable||!1;v.configurable=!0;"value"in v&&(v.writable=!0);Object.defineProperty(l,Ub(v.key),v)}}function Ub(l){a:if("object"===typeof l&&null!==l){var k=l[Symbol.toPrimitive];if(void 0!==k){l=k.call(l,"string");if("object"!==typeof l)break a;throw new TypeError("@@toPrimitive must return a primitive value.");}l=String(l)}return"symbol"===typeof l?l:String(l)}function yb(l){var k=[];if("undefined"!==typeof l.options)for(var q=
...
typeof l?Ca()&&console.warn("[WARNING] [Countly] add_event_listener, Can't bind ["+k+"] event to nonexisting element"):"undefined"!==typeof l.addEventListener?l.addEventListener(k,q,!1):l.attachEvent("on"+k,q))}function Qa(l){return l?"undefined"!==typeof l.target?l.target:l.srcElement:window.event.srcElement}function ua(l){if(l)return l;(l=navigator.userAgent)||(l=Ab());return l}function Ab(l){if(l)return l;l="";navigator.userAgentData&&(l=navigator.userAgentData.brands.map(function(k){return k.brand+
...
function rb(){if(!x)b(c.WARNING,"processScrollView, window object is not available. Not processing scroll view.");else if(Ma){Ma=!1;var a=Ra(),d=kb(),e=Db();f.check_consent("scrolls")&&(a={type:"scroll",y:La+e,width:d,height:a,view:f.getViewUrl()},a=aa(a,f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,"processScrollView",b),f.track_domains&&(a.domain=window.location.hostname),v({key:M.ACTION,segmentation:a}))}}function Ob(a){w("cly_token",a)}function Pb(a,d,e){var h=new Date;h.setTime(h.getTime()+
...
this.track_scrolls=function(a){x?(b(c.INFO,"track_scrolls, Starting to track scrolls"),a&&b(c.INFO,"track_scrolls, Tracking the specified children"),a=a||window,ub=Ma=!0,A(a,"scroll",Nb),A(a,"beforeunload",rb)):b(c.WARNING,"track_scrolls, window object is not available. Not tracking scrolls.")};this.track_links=function(a){x?(b(c.INFO,"track_links, Starting to track clicks to links"),a&&b(c.INFO,"track_links, Tracking the specified children"),a=a||document,A(a,"click",function(d){a:{var e=Qa(d);var h;
...
case "cly_event":J=f.deserialize(d||"[]");break;case "cly_remote_configs":R=f.deserialize(d||"{}");break;case "cly_ignore":f.ignore_visitor=f.deserialize(d);break;case "cly_id":f.device_id=d;break;case "cly_id_type":D=f.deserialize(d)}};this._internals={store:w,getDocWidth:kb,getDocHeight:Ra,getViewportHeight:Db,get_page_coord:jb,get_event_target:Qa,add_event_listener:A,createNewObjectFromProperties:za,truncateObject:aa,truncateSingleValue:z,stripTrailingSlash:ta,prepareParams:ya,sendXmlHttpRequest:Lb,
...
getToken:function(){var a=y("cly_token");S("cly_token");return a},showLoader:Gb,hideLoader:Hb,setValueInStorage:w,getValueFromStorage:y,removeValueFromStorage:S,add_cly_events:v,processScrollView:rb,processScroll:Nb,currentUserAgentString:ua,userAgentDeviceDetection:Bb,userAgentSearchBotDetection:Cb,getRequestQueue:function(){return H},getEventQueue:function(){return J},sendFetchRequest:Mb,makeNetworkRequest:ba,clearQueue:function(){H=[];w("cly_queue",[]);J=[];w("cly_event",[])},getLocalQueues:function(){return{eventQ:J,
