...
function vb(l,k){for(var q=0;q<k.length;q++){var v=k[q];v.enumerable=v.enumerable||!1;v.configurable=!0;"value"in v&&(v.writable=!0);Object.defineProperty(l,Rb(v.key),v)}}function Rb(l){a:if("object"===typeof l&&null!==l){var k=l[Symbol.toPrimitive];if(void 0!==k){l=k.call(l,"string");if("object"!==typeof l)break a;throw new TypeError("@@toPrimitive must return a primitive value.");}l=String(l)}return"symbol"===typeof l?l:String(l)}function wb(l){var k=[];if("undefined"!==typeof l.options)for(var q=
0;q<l.options.length;q++)l.options[q].selected&&k.push(l.options[q].value);return k.join(", ")}function db(){var l=xb("xxxxxxxx","[x]");var k=Date.now().toString();return l+k}function eb(){return xb("xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx","[xy]")}function xb(l,k){var q=(new Date).getTime();return l.replace(new RegExp(k,"g"),function(v){var G=(q+16*Math.random())%16|0;return("x"===v?G:G&3|8).toString(16)})}function F(){return Math.floor((new Date).getTime()/1E3)}function fb(){var l=(new Date).getTime();
Na>=l?Na++:Na=l;return Na}function u(l,k,q){if(k&&Object.keys(k).length){if("undefined"!==typeof k[l])return k[l]}else if("undefined"!==typeof p[l])return p[l];return q}function gb(l,k,q){for(var v in p.i)p.i[v].tracking_crashes&&p.i[v].recordError(l,k,q)}function wa(l){var k=[],q;for(q in l)k.push(q+"="+encodeURIComponent(l[q]));return k.join("&")}function sa(l){return"string"===typeof l&&"/"===l.substring(l.length-1)?l.substring(0,l.length-1):l}function xa(l,k){for(var q={},v,G=0,Q=k.length;G<Q;G++)v=
k[G],"undefined"!==typeof l[v]&&(q[v]=l[v]);return q}function aa(l,k,q,v,G,Q){var O={};if(l){if(Object.keys(l).length>v){var U={},ya=0,ma;for(ma in l)ya<v&&(U[ma]=l[ma],ya++);l=U}for(var za in l)v=z(za,k,G,Q),U=z(l[za],q,G,Q),O[v]=U}return O}function z(l,k,q,v){var G=l;"number"===typeof l&&(l=l.toString());"string"===typeof l&&l.length>k&&(G=l.substring(0,k),v(d.DEBUG,q+", Key: [ "+l+" ] is longer than accepted length. It will be truncated."));return G}function A(l,k,q){x&&(null===l||"undefined"===
typeof l?Aa()&&console.warn("[WARNING] [Countly] add_event_listener, Can't bind ["+k+"] event to nonexisting element"):"undefined"!==typeof l.addEventListener?l.addEventListener(k,q,!1):l.attachEvent("on"+k,q))}function Oa(l){return l?"undefined"!==typeof l.target?l.target:l.srcElement:window.event.srcElement}function ta(l){if(l)return l;l=navigator.userAgent;!l&&navigator.userAgentData&&(l=navigator.userAgentData.brands.map(function(k){return k.brand+":"+k.version}).join(),l+=navigator.userAgentData.mobile?
" mobi ":" ",l+=navigator.userAgentData.platform);return l}function yb(l){if(!l){if(navigator.userAgentData.mobile)return"phone";l=ta()}l=l.toLowerCase();var k="desktop",q=/(mobi|ipod|phone|blackberry|opera mini|fennec|minimo|symbian|psp|nintendo ds|archos|skyfire|puffin|blazer|bolt|gobrowser|iris|maemo|semc|teashark|uzard)/;/(ipad|tablet|(android(?!.*mobile))|(windows(?!.*phone)(.*touch))|kindle|playbook|silk|(puffin(?!.*(IP|AP|WP))))/.test(l)?k="tablet":q.test(l)&&(k="phone");return k}function zb(l){return/(CountlySiteBot|nuhk|Googlebot|GoogleSecurityScanner|Yammybot|Openbot|Slurp|MSNBot|Ask Jeeves\/Teoma|ia_archiver|bingbot|Google Web Preview|Mediapartners-Google|AdsBot-Google|Baiduspider|Ezooms|YahooSeeker|AltaVista|AVSearch|Mercator|Scooter|InfoSeek|Ultraseek|Lycos|Wget|YandexBot|Yandex|YaDirectFetcher|SiteBot|Exabot|AhrefsBot|MJ12bot|TurnitinBot|magpie-crawler|Nutch Crawler|CMS Crawler|rogerbot|Domnutch|ssearch_bot|XoviBot|netseer|digincore|fr-crawler|wesee|AliasIO|contxbot|PingdomBot|BingPreview|HeadlessChrome)/.test(l||
...
function ib(){var l=document;return Math.max(Math.max(l.body.scrollWidth,l.documentElement.scrollWidth),Math.max(l.body.offsetWidth,l.documentElement.offsetWidth),Math.max(l.body.clientWidth,l.documentElement.clientWidth))}function Ab(){var l=document;return Math.min(Math.min(l.body.clientHeight,l.documentElement.clientHeight),Math.min(l.body.offsetHeight,l.documentElement.offsetHeight),window.innerHeight)}function Bb(l,k,q,v,G,Q){l=document.createElement(l);var O;l.setAttribute(k,q);l.setAttribute(v,
G);k=function(){O||Q();O=!0};Q&&(l.onreadystatechange=k,l.onload=k);document.getElementsByTagName("head")[0].appendChild(l)}function Cb(l,k){Bb("script","type","text/javascript","src",l,k)}function Qa(l,k){Bb("link","rel","stylesheet","href",l,k)}function Db(){if(x){var l=document.getElementById("cly-loader");if(!l){var k=document.head||document.getElementsByTagName("head")[0],q=document.createElement("style");q.type="text/css";q.styleSheet?q.styleSheet.cssText="#cly-loader {height: 4px; width: 100%; position: absolute; z-index: 99999; overflow: hidden; background-color: #fff; top:0px; left:0px;}#cly-loader:before{display: block; position: absolute; content: ''; left: -200px; width: 200px; height: 4px; background-color: #2EB52B; animation: cly-loading 2s linear infinite;}@keyframes cly-loading { from {left: -200px; width: 30%;} 50% {width: 30%;} 70% {width: 70%;} 80% { left: 50%;} 95% {left: 120%;} to {left: 100%;}}":
...
"Http response is not JSON: "+h),!1}}function nb(a,c){if(!(200<=a&&300>a))return b(d.ERROR,"Http response status code:["+a+"] is not within the expected range"),!1;try{var e=JSON.parse(c);return"[object Object]"===Object.prototype.toString.call(e)||Array.isArray(e)?!0:(b(d.ERROR,"Http response is not JSON Object nor JSON Array"),!1)}catch(h){return b(d.ERROR,"Http response is not JSON: "+h),!1}}function Kb(){x?Ja=Math.max(Ja,window.scrollY,document.body.scrollTop,document.documentElement.scrollTop):
b(d.WARNING,"processScroll, window object is not available. Not processing scroll.")}function pb(){if(!x)b(d.WARNING,"processScrollView, window object is not available. Not processing scroll view.");else if(Ka){Ka=!1;var a=Pa(),c=ib(),e=Ab();f.check_consent("scrolls")&&(a={type:"scroll",y:Ja+e,width:c,height:a,view:f.getViewUrl()},a=aa(a,f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,"processScrollView",b),f.track_domains&&(a.domain=window.location.hostname),v({key:M.ACTION,segmentation:a}))}}
function Lb(a){w("cly_token",a)}function Mb(a,c,e){var h=new Date;h.setTime(h.getTime()+864E5*e);e="; expires="+h.toGMTString();document.cookie=a+"="+c+e+"; path=/"}function y(a,c,e){if("none"===f.storage||"object"!==L(f.storage)&&!x)b(d.DEBUG,"Storage is disabled. Value with key: ["+a+"] won't be retrieved");else{e||(a=f.app_key+"/"+a,f.namespace&&(a=sa(f.namespace)+"/"+a));if("object"===L(f.storage)&&"function"===typeof f.storage.getItem){var h=f.storage.getItem(a);return a.endsWith("cly_id")?h:
...
JSON.parse(location.hash.replace("#cly:",""))}catch(r){b(d.ERROR,"initialize, Could not parse hash: "+location.hash+", error: "+r)}if((this.passed_data&&this.passed_data.app_key&&this.passed_data.app_key===this.app_key||this.passed_data&&!this.passed_data.app_key&&Wa)&&this.passed_data.token&&this.passed_data.purpose){this.passed_data.token!==y("cly_old_token")&&(Lb(this.passed_data.token),w("cly_old_token",this.passed_data.token));var a=[];Array.isArray(this.heatmapWhitelist)?(this.heatmapWhitelist.push(this.url),
a=this.heatmapWhitelist.map(function(r){return sa(r)})):a=[this.url];a.includes(this.passed_data.url)&&"heatmap"===this.passed_data.purpose&&(this.ignore_visitor=!0,Db(),Cb(this.passed_data.url+"/views/heatmap.js",Eb))}if(this.ignore_visitor)b(d.WARNING,"initialize, ignore_visitor:["+this.ignore_visitor+"], this user will not be tracked");else{b(d.DEBUG,"initialize, app_key:["+this.app_key+"], url:["+this.url+"]");b(d.DEBUG,"initialize, device_id:["+u("device_id",k,void 0)+"]");b(d.DEBUG,"initialize, require_consent is enabled:["+
...
"/o/sdk";$a=500;Ta=1E3;H=[];J=[];R={};ra=[];da={};ca=[];qb=null;Ga=!0;rb=0;W=null;jb=Fa=Ea=0;Za=60;La=20;Ma=0;Xa=60;Ia=100;ua=null;ia=!0;Ha=30;Ya=!0;K=Va=!1;ea={};oa=!0;Nb=F();qa=!0;va=null;D=1;Ka=!1;Ja=0;sb=!1;ka=Ba=ha=null;try{localStorage.setItem("cly_testLocal",!0),localStorage.removeItem("cly_testLocal")}catch(c){b(d.ERROR,"halt, Local storage test failed, will fallback to cookies"),qa=!1}p.features="sessions events views scrolls clicks forms crashes attribution users star-rating location apm feedback remote-config".split(" ");
...
"check_any_consent, require_consent is off, no consent is necessary"),!0;for(var a in E)if(E[a]&&E[a].optin)return!0;b(d.INFO,"check_any_consent, No consents given");return!1};this.add_consent=function(a){b(d.INFO,"add_consent, Adding consent for ["+a+"]");if(Array.isArray(a))for(var c=0;c<a.length;c++)this.add_consent(a[c]);else E[a]?E[a].features?(E[a].optin=!0,this.add_consent(E[a].features)):!0!==E[a].optin&&(E[a].optin=!0,Ob(),setTimeout(function(){"sessions"===a&&ea.begin_session?(f.begin_session.apply(f,
...
this.track_scrolls=function(a){x?(b(d.INFO,"track_scrolls, Starting to track scrolls"),a&&b(d.INFO,"track_scrolls, Tracking the specified children"),a=a||window,sb=Ka=!0,A(a,"scroll",Kb),A(a,"beforeunload",pb)):b(d.WARNING,"track_scrolls, window object is not available. Not tracking scrolls.")};this.track_links=function(a){x?(b(d.INFO,"track_links, Starting to track clicks to links"),a&&b(d.INFO,"track_links, Tracking the specified children"),a=a||document,A(a,"click",function(c){a:{var e=Oa(c);var h;
...
g[e].is_active){var n=g[e].target_devices,r=yb();if(n[r])if("string"===typeof g[e].hide_sticker&&(g[e].hide_sticker="true"===g[e].hide_sticker),"all"!==g[e].target_page||g[e].hide_sticker){var t=g[e].target_pages;for(h=0;h<t.length;h++){var I=t[h].substr(0,t[h].length-1)===window.location.pathname.substr(0,t[h].length-1),C=t[h]===window.location.pathname;(t[h].includes("*")&&I||C)&&!g[e].hide_sticker&&U(g[e],!0)}}else U(g[e],!0)}}catch(na){b(d.ERROR,"initializeRatingWidgets, JSON parse error: "+na)}},
...
a);b(d.DEBUG,"onStorageChange, Applying storage changes for value:",c);switch(a){case "cly_queue":H=f.deserialize(c||"[]");break;case "cly_event":J=f.deserialize(c||"[]");break;case "cly_remote_configs":R=f.deserialize(c||"{}");break;case "cly_ignore":f.ignore_visitor=f.deserialize(c);break;case "cly_id":f.device_id=c;break;case "cly_id_type":D=f.deserialize(c)}};this._internals={store:w,getDocWidth:ib,getDocHeight:Pa,getViewportHeight:Ab,get_page_coord:hb,get_event_target:Oa,add_event_listener:A,
createNewObjectFromProperties:xa,truncateObject:aa,truncateSingleValue:z,stripTrailingSlash:sa,prepareParams:wa,sendXmlHttpRequest:Ib,isResponseValid:ob,getInternalDeviceIdType:function(){return D},getMsTimestamp:fb,getTimestamp:F,isResponseValidBroad:nb,secureRandom:db,log:b,checkIfLoggingIsOn:Aa,getMetrics:Ra,getUA:Hb,prepareRequest:Ca,generateUUID:eb,sendEventsForced:O,isUUID:function(a){return/[0-9a-fA-F]{8}\-[0-9a-fA-F]{4}\-4[0-9a-fA-F]{3}\-[0-9a-fA-F]{4}\-[0-9a-fA-F]{12}/.test(a)},isReferrerUsable:mb,
getId:lb,heartBeat:Ua,toRequestQueue:N,reportViewDuration:ma,loadJS:Cb,loadCSS:Qa,getLastView:function(){return W},setToken:Lb,getToken:function(){var a=y("cly_token");X("cly_token");return a},showLoader:Db,hideLoader:Eb,setValueInStorage:w,getValueFromStorage:y,removeValueFromStorage:X,add_cly_events:v,processScrollView:pb,processScroll:Kb,currentUserAgentString:ta,userAgentDeviceDetection:yb,userAgentSearchBotDetection:zb,getRequestQueue:function(){return H},getEventQueue:function(){return J},sendFetchRequest:Jb,
...
w(S.errorCount,f.hcErrorCount);w(S.warningCount,f.hcWarningCount);w(S.statusCode,f.hcStatusCode);w(S.errorMessage,f.hcErrorMessage)},incrementErrorCount:function(){f.hcErrorCount++},incrementWarningCount:function(){f.hcWarningCount++},resetCounters:function(){f.hcErrorCount=0;f.hcWarningCount=0;f.hcStatusCode=-1;f.hcErrorMessage=""},saveRequestCounters:function(a,c){f.hcStatusCode=a;f.hcErrorMessage=c;w(S.statusCode,f.hcStatusCode);w(S.errorMessage,f.hcErrorMessage)}};this.initialize()}),Qb=!0;p.features=
"apm attribution clicks crashes events feedback forms location remote-config scrolls sessions star-rating users views".split(" ");p.q=p.q||[];p.onload=p.onload||[];p.CountlyClass=Pb;p.init=function(k){k=k||{};if(p.loadAPMScriptsAsync&&Qb)Qb=!1,Sb(k);else{var q=k.app_key||p.app_key;if(!p.i||!p.i[q]){k=new Pb(k);if(!p.i){p.i={};for(var v in k)p[v]=k[v]}p.i[q]=k}return p.i[q]}};p.serialize=function(k){"object"===L(k)&&(k=JSON.stringify(k));return k};p.deserialize=function(k){if(""===k)return k;try{k=
JSON.parse(k)}catch(q){Aa()&&console.warn("[WARNING] [Countly] deserialize, Could not parse the file:["+k+"], error: "+q)}return k};p.getViewName=function(){return x?window.location.pathname:"web_worker"};p.getViewUrl=function(){return x?window.location.pathname:"web_worker"};p.getSearchQuery=function(){if(x)return window.location.search};p.DeviceIdType={DEVELOPER_SUPPLIED:0,SDK_GENERATED:1,TEMPORARY_ID:2};x&&window.addEventListener("storage",function(k){var q=(k.key+"").split("/"),v=q.pop();q=q.pop();
