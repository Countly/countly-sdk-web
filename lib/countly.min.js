...
e.onreadystatechange=function(){4===this.readyState&&200<=this.status&&300>this.status?"function"===typeof f&&(c.end_session?setTimeout(function(){f(!1,c,this.responseText)},3E3):f(!1,c,this.responseText)):4===this.readyState&&(i("Failed Server XML HTTP request",this.status),"function"===typeof f&&f(!0,c))};"GET"===d?e.send():e.send(g)}catch(h){i("Failed XML HTTP request",h),"function"===typeof f&&f(!0,c)}}function sa(a){var c=[],b;for(b in a)c.push(b+"="+encodeURIComponent(a[b]));return c.join("&")}
function ta(a){return"/"===a.substr(a.length-1)?a.substr(0,a.length-1):a}function Q(a,b){for(var f={},e,g=0;g<b.length;g++)e=b[g],"undefined"!==typeof a[e]&&(f[e]=a[e]);return f}function aa(a){"undefined"==typeof a.pageY&&("number"==typeof a.clientX&&document.documentElement)&&(a.pageX=a.clientX+document.body.scrollLeft+document.documentElement.scrollLeft,a.pageY=a.clientY+document.body.scrollTop+document.documentElement.scrollTop);return a}function ba(){var a=document;return Math.max(Math.max(a.body.scrollHeight,
