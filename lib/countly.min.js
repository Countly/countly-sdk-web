...
u("cly_event",J);b(d.INFO,"With event ID: ["+a.id+"], successfully adding the last event:",a)}else b(d.ERROR,"Adding event failed. Event must have a key property")}function t(a,c,e,k,l){b(d.INFO,"fetch_remote_config_explicit, Fetching sequence initiated");var g={method:"rc"};a&&(g.keys=JSON.stringify(a));c&&(g.omit_keys=JSON.stringify(c));var n;"legacy"===k&&(g.method="fetch_remote_config");0===e&&(g.oi=0);1===e&&(g.oi=1);"function"===typeof l&&(n=l);f.check_consent("sessions")&&(g.metrics=JSON.stringify(Ka()));
f.check_consent("remote-config")?(Z(g),aa("fetch_remote_config_explicit",f.url+La,g,function(q,v,K){if(q)b(d.ERROR,"fetch_remote_config_explicit, An error occurred: "+q);else{try{var S=JSON.parse(K);if(g.keys||g.omit_keys)for(var L in S)O[L]=S[L];else O=S;u("cly_remote_configs",O)}catch(pa){b(d.ERROR,"fetch_remote_config_explicit, Had an issue while parsing the response: "+pa)}n&&(b(d.INFO,"fetch_remote_config_explicit, Callback function is provided"),n(q,O))}},!0)):(b(d.ERROR,"fetch_remote_config_explicit, Remote config requires explicit consent"),
n&&n(Error("Remote config requires explicit consent"),O))}function A(){f.ignore_prefetch&&"undefined"!==typeof document.visibilityState&&"prerender"===document.visibilityState&&(f.ignore_visitor=!0);f.ignore_bots&&rb()&&(f.ignore_visitor=!0)}function B(){0<J.length&&(b(d.DEBUG,"Flushing events"),G({events:JSON.stringify(J)}),J=[],u("cly_event",J))}function M(a,c){if(document.getElementById("countly-feedback-sticker-"+a._id))b(d.ERROR,"Widget with same ID exists");else try{var e=document.createElement("div");
e.className="countly-iframe-wrapper";e.id="countly-iframe-wrapper-"+a._id;var k=document.createElement("span");k.className="countly-feedback-close-icon";k.id="countly-feedback-close-icon-"+a._id;k.innerText="x";var l=document.createElement("iframe");l.name="countly-feedback-iframe";l.id="countly-feedback-iframe";l.src=f.url+"/feedback?widget_id="+a._id+"&app_key="+f.app_key+"&device_id="+f.device_id+"&sdk_version=23.6.2";document.body.appendChild(e);e.appendChild(k);e.appendChild(l);y(document.getElementById("countly-feedback-close-icon-"+
a._id),"click",function(){document.getElementById("countly-iframe-wrapper-"+a._id).style.display="none";document.getElementById("cfbg").style.display="none"});if(c){var g=document.createElementNS("http://www.w3.org/2000/svg","svg");g.id="feedback-sticker-svg";g.setAttribute("aria-hidden","true");g.setAttribute("data-prefix","far");g.setAttribute("data-icon","grin");g.setAttribute("class","svg-inline--fa fa-grin fa-w-16");g.setAttribute("role","img");g.setAttribute("xmlns","http://www.w3.org/2000/svg");
g.setAttribute("viewBox","0 0 496 512");var n=document.createElementNS("http://www.w3.org/2000/svg","path");n.id="smileyPathInStickerSvg";n.setAttribute("fill","white");n.setAttribute("d","M248 8C111 8 0 119 0 256s111 248 248 248 248-111 248-248S385 8 248 8zm0 448c-110.3 0-200-89.7-200-200S137.7 56 248 56s200 89.7 200 200-89.7 200-200 200zm105.6-151.4c-25.9 8.3-64.4 13.1-105.6 13.1s-79.6-4.8-105.6-13.1c-9.9-3.1-19.4 5.4-17.7 15.3 7.9 47.1 71.3 80 123.3 80s115.3-32.9 123.3-80c1.6-9.8-7.7-18.4-17.7-15.3zM168 240c17.7 0 32-14.3 32-32s-14.3-32-32-32-32 14.3-32 32 14.3 32 32 32zm160 0c17.7 0 32-14.3 32-32s-14.3-32-32-32-32 14.3-32 32 14.3 32 32 32z");
